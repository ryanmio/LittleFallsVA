...
- Homepage showcasing the cause and reasons for the proposed name change
- Press section with press releases and media contacts
- History section providing a historical context (contents not displayed in current view)
- Store section for supporters to purchase merchandise (contents not displayed in current view)
- Petition section where visitors can digitally sign a petition supporting the name change
