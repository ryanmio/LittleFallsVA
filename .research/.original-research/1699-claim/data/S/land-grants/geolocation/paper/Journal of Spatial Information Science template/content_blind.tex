...
al.\textasciitilde{}\citep{Li2024_geoai} and detailed further in §2.4.
...
resolution) \citep{karimzadeh2019geocorpora}, outperforming previous
...
\citep{gritta2018wiktor} the same architecture reached 0.98. Crucially,
...
cascading trio of geocoders---GeoNames gazetteer \citep{geonames},
Nominatim (OpenStreetMap geocoder) \citep{nominatim}, and ArcGIS World
Geocoding Service \citep{arcgis_world_geocoding}---to resolve toponyms
...
\citep{geoglue} and an in-house Chinese address dataset, demonstrating
...
responsibility}, which Li et al.\textasciitilde{}\citep{Li2024_geoai}
