...
%--------------------------------------------------
% Extra packages & Unicode definitions for clean pdfLaTeX on arXiv
\usepackage{float} % allows the [H] float placement used by Pandoc tables
% Map problematic Unicode characters to LaTeX equivalents
...
\DeclareUnicodeCharacter{27F7}{$\leftrightarrow$}
\DeclareUnicodeCharacter{00C2}{}
\DeclareUnicodeCharacter{2022}{\textbullet}
\DeclareUnicodeCharacter{2013}{--}
\DeclareUnicodeCharacter{2014}{---}
% Ensure listings handles these UTF-8 glyphs
\AtBeginDocument{\lstset{
  extendedchars=true,
  inputencoding=utf8,
...
%--------------------------------------------------
\makeatletter
\newenvironment{longtable}{\onecolumn\begin{longtable}}{\end{longtable}\twocolumn}
\makeatother
%--------------------------------------------------
...
Pioneers}
(C\&P)\textsuperscript{\citeproc{ref-Nugent1979_cavaliers3}{1}}. Without
...
\item
  ...
  workflow\textsuperscript{\citeproc{ref-Bashorun2025_gis}{2}},
  deterministic pipelines such as the GeoTxt Stanford NER
  geoparser\textsuperscript{\citeproc{ref-karimzadeh2019geotxt}{3}},
  neural geoparsers like
  Mordecai-3\textsuperscript{\citeproc{ref-halterman2023mordecai}{4}},
...
al.\textsuperscript{\citeproc{ref-Li2024_geoai}{5}} and detailed further
in §2.4.
...
\item
  ...
  3\textsuperscript{\citeproc{ref-Nugent1979_cavaliers3}{1}}, including
...
Abbitt\textsuperscript{\citeproc{ref-Julian2014_tennessee}{6}} required
...
utility for spatial
analysis\textsuperscript{\citeproc{ref-lva_patents_db}{7}}. Similarly,
Loudoun County GIS staff have successfully reconstructed all original
grants within their
jurisdiction\textsuperscript{\citeproc{ref-loudoun_grants_dataset}{8}}.
...
proprietary are
Mitchell's\textsuperscript{\citeproc{ref-mitchell1977whiteoak}{9}} maps
...
Fausz\textsuperscript{\citeproc{ref-Fausz1971_settlement}{10}} utilized
...
Dobbs\textsuperscript{\citeproc{ref-Dobbs2009_backcountry}{11}} used
...
Nelson\textsuperscript{\citeproc{ref-Coughlan2018_settlement}{12}}
...
DeedMapper
software\textsuperscript{\citeproc{ref-DeedMapper_software}{13}} helps
...
CamCoder\textsuperscript{\citeproc{ref-Gritta2018_camcoder}{14}}
...
al.\textsuperscript{\citeproc{ref-Hu2024_toponym_llm}{15}}, who
...
al.\textsuperscript{\citeproc{ref-wu2025geosg}{16}} introduced GeoSG, a
...
vein, Savarro et
al.\textsuperscript{\citeproc{ref-savarro2024geolingit}{17}}
...
al.\textsuperscript{\citeproc{ref-Osullivan2024_metric}{18}}
...
al.\textsuperscript{\citeproc{ref-Hu2024_toponym_llm}{15}}, who coupled
...
Huang et al.\textsuperscript{\citeproc{ref-Huang2024_geoagent}{19}}
...
paradigm\textsuperscript{\citeproc{ref-yao2023react}{20}}, which
...
initiative\textsuperscript{\citeproc{ref-GoogleResearch2025_geospatial}{21}}
...
(Hu et al.\textsuperscript{\citeproc{ref-Hu2024_toponym_llm}{15}}; Huang
et al.\textsuperscript{\citeproc{ref-Huang2024_geoagent}{19}}). The
...
al.\textsuperscript{\citeproc{ref-Li2024_geoai}{5}} identify as four
...
3\textsuperscript{\citeproc{ref-Nugent1979_cavaliers3}{1}} contains
5,471 abstracts of Virginia land patents recorded in patent books 9--14
(1695--1732). The digitized
corpus\textsuperscript{\citeproc{ref-mioduski_2025_cvp3}{22}} provides
...
History\textsuperscript{\citeproc{ref-central_va_patents_gis}{23}}.
...
A certified GIS
analyst\textsuperscript{\citeproc{ref-Bashorun2025_gis}{2}} implemented
...
geoparser\textsuperscript{\citeproc{ref-halterman2023mordecai}{4}},
...
\item
  ...
  H-1\textsuperscript{\citeproc{ref-Bashorun2025_gis}{2}} (−6.6 km) and
...
\item
  ...
  Shared
  Story\textsuperscript{\citeproc{ref-central_va_patents_gis}{23}} and
...
\item
  ...
  baseline\textsuperscript{\citeproc{ref-Bashorun2025_gis}{2}} relies on
...
\item
  ...
  \emph{Cavaliers and
  Pioneers}\textsuperscript{\citeproc{ref-Nugent1979_cavaliers3}{1}}---and
...
perceived to bias this research. The research
...
research evaluation purposes. The author is
...
opinions expressed are solely those of the author. No
personal relationships or affiliations influenced the work.
The author has not publicly advocated positions
that would benefit from the results. All datasets
...
Bashorun\textsuperscript{\citeproc{ref-Bashorun2025_gis}{2}} for
...
professional GIS benchmark
(H-1)\textsuperscript{\citeproc{ref-Bashorun2025_gis}{2}} results,
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{map_outputs/contact_sheet.png}
\caption{Grid view of all 43 mapped grants showing ground truth and predictions.}\label{fig:contactsheet}
\end{figure}
