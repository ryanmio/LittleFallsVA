\DIFaddbegin \section{\DIFadd{Introduction}}\label{introduction}

\DIFaddend \subsection{Historical Context \&
...
coordinates, historians and archaeologists cannot readily \DIFdelbegin \DIFdel{visualise }\DIFdelend \DIFaddbegin \DIFadd{visualize }\DIFaddend how
...
\DIFdelbegin \DIFdel{Digitising }\DIFdelend \DIFaddbegin \DIFadd{Digitizing }\DIFaddend and geo-locating the abstracts, however, is notoriously
...
\DIFadd{Example grant abstract (C\&P Vol. 3, pp.~78--79; abstracting Patent Book
9, p.~571; 23 Oct.~1703):
}

\DIFadd{``JOHN POYTHRESS, 609 A., 2 R., \& 9 P., Chas. City Co; on S. side of
...
\DIFadd{This typical abstract uses abbreviated surveyor jargon (e.g., Sw., Riv.,
br.), chained landmarks, and adjacency clauses to neighboring tracts to
narratively describe the parcel.
}

\DIFaddend \subsection{Problem Statement}\label{problem-statement}
...
\item
  ...
  \DIFdelbegin \DIFdel{understand }\DIFdelend \DIFaddbegin \DIFadd{reliably parse }\DIFaddend seventeenth-century toponyms and bearing conventions
  \DIFaddbegin \DIFadd{and resolve them to coordinates}\DIFaddend ?
\item
...
al.\DIFaddbegin \DIFadd{~}\DIFaddend \citep{Li2024_geoai} and detailed further in \DIFdelbegin \DIFdel{§}\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 2.4\DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{,
and---relative to classic geoparsers such as Stanford NER/GeoTxt
\mbox{%DIFAUXCMD
\citep{karimzadeh2019geotxt}}\hskip0pt%DIFAUXCMD
, Mordecai‑3 \mbox{%DIFAUXCMD
\citep{halterman2023mordecai}}\hskip0pt%DIFAUXCMD
,
and the map‑aware CamCoder \mbox{%DIFAUXCMD
\citep{Gritta2018_camcoder}}\hskip0pt%DIFAUXCMD
---centers on
...
\item
  ...
  on \DIFdelbegin \textbf{\DIFdel{Zenodo (DOI: 10.5281/zenodo.16269949)}}%DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{Zenodo (DOI: 10.5281/zenodo.16269949)}\DIFaddend ; qualified researchers can
...
\DIFdelbegin \DIFdel{§
}\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 2.1, recent advances in large language models (LLMs) suggest
...
al.\DIFaddbegin \DIFadd{~}\DIFaddend \citep{Hu2024_toponym_llm}, who fine-tuned Llama 2-7B to generate an
...
on the GeoCorpora set \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{wallgrun2017geocorpora}}\hskip0pt%DIFAUXCMD
}\DIFaddend , outperforming
...
corpus \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{gritta2018whatsmissing} }\hskip0pt%DIFAUXCMD
}\DIFaddend the same architecture reached
...
al.\DIFaddbegin \DIFadd{~}\DIFaddend \citep{wu2025geosg} introduced GeoSG, a self-supervised graph neural
...
al.\DIFaddbegin \DIFadd{~}\DIFaddend \citep{savarro2024geolingit} demonstrated that Italian tweets can be
...
al.\DIFaddbegin \DIFadd{~}\DIFaddend \citep{Osullivan2024_metric} demonstrated that GPT-class models
...
In summary, \DIFdelbegin \DIFdel{fine-tuned }\DIFdelend \DIFaddbegin \DIFadd{fine‑tuned }\DIFaddend LLMs now surpass previous neural approaches on
toponym resolution and can support \DIFdelbegin \DIFdel{colony-scale }\DIFdelend \DIFaddbegin \DIFadd{colony‑scale }\DIFaddend spatial inference, yet
their reasoning remains sensitive to context and \DIFdelbegin \DIFdel{scale. }\DIFdelend \DIFaddbegin \DIFadd{scale---findings
established largely on short, contemporary corpora such as GeoCorpora
and WikToR \mbox{%DIFAUXCMD
\citep{wallgrun2017geocorpora, gritta2018whatsmissing}}\hskip0pt%DIFAUXCMD
. By
contrast, we evaluate long‑form colonial abstracts with obsolete
toponyms and surveyor jargon against 43 curated ground‑truth points. }\DIFaddend The
next section (\DIFdelbegin \DIFdel{§ }\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 2.3) explores \DIFdelbegin \DIFdel{tool-augmented }\DIFdelend \DIFaddbegin \DIFadd{tool‑augmented }\DIFaddend prompting frameworks
...
\DIFdelbegin \DIFdel{§
}\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 2.2. In a \emph{tool-augmented} workflow, the LLM interprets
...
al.\DIFaddbegin \DIFadd{~}\DIFaddend \citep{Hu2024_toponym_llm}, who coupled a fine-tuned Llama 2-7B with
a cascading trio of geocoders---GeoNames \DIFdelbegin \DIFdel{, Nominatim, and ArcGIS---to
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{geonames_about}}\hskip0pt%DIFAUXCMD
,
Nominatim \mbox{%DIFAUXCMD
\citep{nominatim_project}}\hskip0pt%DIFAUXCMD
, and ArcGIS Online
\mbox{%DIFAUXCMD
\citep{esri_arcgis_online}}\hskip0pt%DIFAUXCMD
---to }\DIFaddend resolve toponyms the model had already
...
Huang et al.\DIFaddbegin \DIFadd{~}\DIFaddend \citep{Huang2024_geoagent} developed GeoAgent for free-form
...
\citep{li2023geogluegeographiclanguageunderstanding} }\hskip0pt%DIFAUXCMD
}\DIFaddend and an in-house
...
(Hu et al.\DIFaddbegin \DIFadd{~}\DIFaddend \citep{Hu2024_toponym_llm}; Huang et
al.\DIFaddbegin \DIFadd{~}\DIFaddend \citep{Huang2024_geoagent}). The present work builds on this pattern
by testing whether a similar benefit materializes for colonial
\DIFdelbegin \DIFdel{land-grant
}\DIFdelend \DIFaddbegin \DIFadd{land‑grant }\DIFaddend geolocation---comparing a pure \DIFdelbegin \DIFdel{one-shot }\DIFdelend \DIFaddbegin \DIFadd{one‑shot }\DIFaddend prompt to a
\DIFdelbegin \DIFdel{tool-augmented
chain-of-thought }\DIFdelend \DIFaddbegin \DIFadd{tool‑augmented chain‑of‑thought }\DIFaddend that can issue \DIFdelbegin \DIFdel{mid-prompt geocoding and
distance-calculation }\DIFdelend \DIFaddbegin \DIFadd{mid‑prompt geocoding and
distance‑calculation }\DIFaddend calls while processing \DIFdelbegin \DIFdel{historical texts with
archaic toponyms and
surveying terminology. }\DIFdelend \DIFaddbegin \DIFadd{English‑language colonial
...
\mbox{%DIFAUXCMD
\citep{Huang2024_geoagent, li2023geogluegeographiclanguageunderstanding}}\hskip0pt%DIFAUXCMD
,
...
responsibility}, which Li et al.\DIFaddbegin \DIFadd{~}\DIFaddend \citep{Li2024_geoai} identify as four
...
(Figures \ref{fig:pareto_cost} and \DIFdelbegin \DIFdel{\ref{fig:pareto_latency}}\DIFdelend \DIFaddbegin \DIFadd{\ref{fig:latency_box}}\DIFaddend ) demonstrating
...
ablations reported in \DIFdelbegin \DIFdel{§ }\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 6.6, showing that accuracy is essentially
...
model's \DIFdelbegin \DIFdel{internal reasoning}\DIFdelend \DIFaddbegin \DIFadd{inference trace}\DIFaddend , enabling researchers to reconstruct exactly how
and why a given prediction was \DIFdelbegin \DIFdel{made}\DIFdelend \DIFaddbegin \DIFadd{produced}\DIFaddend . For instance, as detailed in
Section 6.4 and Appendix A.3, the logs clearly document how the
\DIFdelbegin \DIFdel{models
}\DIFdelend \DIFaddbegin \DIFadd{pipelines }\DIFaddend identify key geographic features, choose between multiple
...
\DIFdelbegin \DIFdel{Capturing
these detailed reasoning steps across both prompting paradigms (direct
one-shot versus iterative, tool-augmented reasoning) provides unprecedented }\DIFdelend \DIFaddbegin \DIFadd{Because every intermediate output and tool interaction is logged, the
record provides trace‑level }\DIFaddend transparency into the \DIFdelbegin \DIFdel{models'cognitive processes}\DIFdelend \DIFaddbegin \DIFadd{model's inference‑time
behavior}\DIFaddend . This explicit audit trail \DIFdelbegin \DIFdel{reveals precisely where models succeed or fail, }\DIFdelend \DIFaddbegin \DIFadd{pinpoints where the pipeline
succeeds or fails in practice (as observed in outputs, tool
interactions, and error metrics), }\DIFaddend highlighting systematic errors such as
...
code repository and described in \DIFdelbegin \DIFdel{§ }\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 3, allowing others to exactly
...
\subsection{\DIFdelbegin \DIFdel{Digitisation }\DIFdelend \DIFaddbegin \DIFadd{Digitization }\DIFaddend \&
Pre-processing}\DIFdelbegin %DIFDELCMD < \label{digitisation-pre-processing}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \label{digitization-pre-processing}
\DIFaddend 
...
To facilitate reproducible experimentation\DIFdelbegin \DIFdel{three deterministic splits
were drawn with fixed random seeds}\DIFdelend \DIFaddbegin \DIFadd{, the dev/test split and
...
From the \DIFdelbegin \DIFdel{125-item }\DIFdelend \DIFaddbegin \DIFadd{125‑item }\DIFaddend test partition, 43 abstracts were matched to polygons
...
The 43 \DIFdelbegin \DIFdel{points arise }\DIFdelend \DIFaddbegin \DIFadd{cases come }\DIFaddend from a simple random draw (125 abstracts) followed by
archival \DIFdelbegin \DIFdel{verification; they were not cherry-picked for textual
clarity or spatial convenience. }\DIFdelend \DIFaddbegin \DIFadd{verification---chosen to balance external validity with
...
\DIFaddbegin \DIFadd{To ground the reader before introducing stronger automated pipelines, we
...
\subsection{\DIFadd{County-Centroid Baseline
(H-4)}}\label{county-centroid-baseline-h-4}

\DIFadd{Method H-4 provides a transparent deterministic floor. A regex extracts
...
\DIFaddend \subsection{Stanford NER Baseline
...
it defaults to Virginia's geographic center (37.4316, -78.6569). \DIFaddbegin \DIFadd{On the
43‑grant evaluation set, this statewide‑centroid default was invoked in
4 of 43 cases (\textasciitilde9.3\%). }\DIFaddend This approach ensures 100\%
...
centuries, as detailed in the case study analysis (\DIFdelbegin \DIFdel{§}\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 7.2.1).
...
\DIFdelbegin \subsection{\DIFdel{County-Centroid Baseline
(H-4)}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{county-centroid-baseline-h-4}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Method H-4 provides a transparent deterministic floor. A regex extracts
any Virginia county name (handling forms like ``Henrico Co.'', ``City of
Norfolk'', etc.); if successful, the script returns the pre-computed
TIGER/Line centroid of that county. When no county is detected it
defaults to the geographic centre of Virginia (37.4316 °N, -78.6569 °W).
...
%DIFDELCMD < %%%
\DIFdelend \subsection{One-shot Prompting
...
\DIFaddbegin \DIFadd{Section 6.1 (Table \ref{tbl:accuracy}) shows M-series mean errors
...
\begin{longtable}[]{@{}ll@{}}
\caption{\label{tbl:mmodels}\DIFdelbegin \DIFdel{One-shot }\DIFdelend \DIFaddbegin \DIFadd{Evaluated one-shot }\DIFaddend model variants
(\DIFdelbegin \DIFdel{M-series}\DIFdelend \DIFaddbegin \DIFadd{M‑series}\DIFaddend ).}\tabularnewline
\toprule\noalign{}
ID & Model \\
\midrule\noalign{}
\endfirsthead
...
\bottomrule\noalign{}
\endlastfoot
M-1 & \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!o4-mini-2025-04-16!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{o4-mini-2025-04-16}} \DIFaddend \\
M-2 & \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!o3-2025-04-16!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{o3-2025-04-16}} \DIFaddend \\
M-3 & \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!o3-mini-2025-01-31!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{o3-mini-2025-01-31}} \DIFaddend \\
M-4 & \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!gpt-4.1-2025-04-14!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{gpt-4.1-2025-04-14}} \DIFaddend \\
M-5 & \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!gpt-4o-2024-08-06!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{gpt-4o-2024-08-06}} \DIFaddend \\
M-6 & \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!gpt-3.5-turbo!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{gpt-3.5-turbo}} \DIFaddend \\
\end{longtable}
...
tools: \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!geocode\_place!}%%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{geocode\_place}}\DIFaddend , an interface to the Google Geocoding API
limited to Virginia and adjoining counties, and
\DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!compute\_centroid!}%%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{compute\_centroid}}\DIFaddend , which returns the spherical centroid of two
...
insights into tool-augmented performance. \DIFaddbegin \DIFadd{In this setting the
...
\begin{longtable}[]{@{}ll@{}}
\caption{\label{tbl:tmodels}\DIFdelbegin \DIFdel{Tool-augmented }\DIFdelend \DIFaddbegin \DIFadd{Evaluated tool‑augmented }\DIFaddend model variants
(\DIFdelbegin \DIFdel{T-series}\DIFdelend \DIFaddbegin \DIFadd{T‑series}\DIFaddend ).}\tabularnewline
\toprule\noalign{}
ID & Model \\
\midrule\noalign{}
\endfirsthead
...
\bottomrule\noalign{}
\endlastfoot
T-1 & \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!o4-mini-2025-04-16!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{o4-mini-2025-04-16}} \DIFaddend \\
T-2 & \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!o3-2025-04-16!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{o3-2025-04-16}} \DIFaddend \\
T-3 & \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!o3-mini-2025-01-31!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{o3-mini-2025-01-31}} \DIFaddend \\
T-4 & \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!gpt-4.1-2025-04-14!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{gpt-4.1-2025-04-14}} \DIFaddend \\
T-5 & \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!computer-use-preview-2025-03-11!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{computer-use-preview-2025-03-11}} \DIFaddend \\
\end{longtable}
...
independent one-shot calls to \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!o3-2025-04-16!}%%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{o3-2025-04-16}}\DIFaddend ,
...
km\DIFaddbegin \DIFadd{, MinPts = 3}\DIFaddend ). If at least three predictions fall within the same 0.5
...
The ensemble (method E-1) achieves a mean error of \DIFdelbegin \DIFdel{18.7 }\DIFdelend \DIFaddbegin \DIFadd{19.2 }\DIFaddend km---the best of
...
name-redacted ablation (E-2, see \DIFdelbegin \DIFdel{§ }\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 6.6) confirms that the gain is
...
million tokens (see Table \DIFdelbegin \DIFdel{\textasciitilde{}}\DIFdelend \ref{tbl:prices}). Google Geocoding calls
...
processed (43), yielding an average latency of 502 s per prediction. \DIFaddbegin \DIFadd{For
...
\DIFdelbegin \DIFdel{Efficiency is characterized by two key metrics:
}\DIFdelend \DIFaddbegin \DIFadd{We also report efficiency via latency and monetary cost, defined
...
\item%DIFAUXCMD
%DIFDELCMD <   %%%
\DIFdel{Latency: Measured as mean labor time per grant (forward-pass time once
  the workflow is in place)
}%DIFDELCMD < \item
\item%DIFAUXCMD
%DIFDELCMD <   %%%
\DIFdel{Monetary cost: Calculated by multiplying input and output token counts
...
%DIFDELCMD < %%%
\DIFdel{The GIS benchmark incurred a fixed fee of USD 140 for approximately six
...
%DIFDELCMD < %%%
\DIFdelend All metrics are computed on the 43 test-set abstracts for which
...
For each method listed in Tables \DIFdelbegin \DIFdel{\textasciitilde{}\ref{tbl:mmodels} and
\textasciitilde{}}\DIFdelend \DIFaddbegin \DIFadd{\ref{tbl:mmodels} and
}\DIFaddend \ref{tbl:tmodels}, an evaluation driver sequentially processed the 43
...
\DIFaddbegin \DIFadd{When supported (e.g., GPT‑4.1/4o/3.5), we set temperature t = 0.2;
...
same model (E-1) tightens accuracy to \DIFdelbegin \DIFdel{19 }\DIFdelend \DIFaddbegin \DIFadd{19.2 }\DIFaddend km, pushing \DIFdelbegin \DIFdel{nearly 40}\DIFdelend \DIFaddbegin \DIFadd{35}\DIFaddend \% of
...
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1500}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4000}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1500}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1500}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1500}}@{}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1304}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1304}}@{}}
\DIFaddend \caption{\label{tbl:accuracy}\DIFdelbegin \DIFdel{Coordinate-accuracy
metrics}\DIFdelend \DIFaddbegin \DIFadd{Comparative coordinate accuracy by method;
mean ± 95\% CI and median indicate central tendency, and the ≤10 km
column highlights high‑precision hits}\DIFaddend .}\tabularnewline
\toprule\noalign{}
...
\bottomrule\noalign{}
\endlastfoot
E-1 & o3-2025-04-16 (ensemble) & \DIFdelbegin \DIFdel{18.7 }\DIFdelend \DIFaddbegin \DIFadd{19.2 }\DIFaddend {[}13.6, 25.0{]} & \DIFdelbegin \DIFdel{12.5 }\DIFdelend \DIFaddbegin \DIFadd{12.2 }\DIFaddend & \DIFdelbegin \DIFdel{39.5 }\DIFdelend \DIFaddbegin \DIFadd{34.9 }\DIFaddend \\
E-2 & ensemble name-redacted & \DIFdelbegin \DIFdel{20.4 }\DIFdelend \DIFaddbegin \DIFadd{20.6 }\DIFaddend {[}15.1, 26.8{]} & \DIFdelbegin \DIFdel{13.8 }\DIFdelend \DIFaddbegin \DIFadd{13.4 }\DIFaddend & \DIFdelbegin \DIFdel{34.9 }\DIFdelend \DIFaddbegin \DIFadd{30.2 }\DIFaddend \\
...
95\% confidence intervals. \DIFaddbegin \DIFadd{This figure enables direct comparison of
...
\caption{\DIFdelbeginFL \DIFdelFL{Coordinate accuracy }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Mean geolocation error }\DIFaddendFL by method \DIFaddbeginFL \DIFaddFL{with 95\% CIs on 43 grants;
enables direct accuracy comparison across LLMs and
baselines.}\DIFaddendFL }\label{fig:accuracy_bar}
\end{figure}
...
%DIFDELCMD < %%%
\DIFdelend The violin plot in Figure \ref{fig:violin} shows that most LLM errors
cluster below 40 km, with a long tail driven by a handful of outliers.
\DIFaddbegin \DIFadd{This view emphasises the tighter concentration for LLMs and the broader
...
\caption{Error \DIFdelbeginFL \DIFdelFL{Distribution }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{distributions }\DIFaddendFL by \DIFdelbeginFL \DIFdelFL{Method}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{method; shows spread, skew, and outliers
for LLMs versus baselines.}\DIFaddendFL }\label{fig:violin}
\end{figure}
...
\caption{\DIFdelbeginFL \DIFdelFL{Core error distribution (}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Error distributions for }\DIFaddendFL LLMs vs.~GIS \DIFdelbeginFL \DIFdelFL{baseline)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{analyst only, isolating
core methods from heuristic baselines.}\DIFaddendFL }\label{fig:violin_core}
\end{figure}

Figure \ref{fig:cdf_models} \DIFdelbegin \DIFdel{presents }\DIFdelend \DIFaddbegin \DIFadd{plots }\DIFaddend the cumulative distribution \DIFdelbegin \DIFdel{of
errors for each evaluated method. }\DIFdelend \DIFaddbegin \DIFadd{function
...
\caption{Cumulative \DIFdelbeginFL \DIFdelFL{error distribution by method}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{accuracy vs.~distance threshold (km); higher‑left
curves indicate better performance across
thresholds.}\DIFaddendFL }\label{fig:cdf_models}
\end{figure}
...
\DIFaddbegin \DIFadd{Three key observations emerge: (1) modern LLMs can match or exceed a
...
\DIFdelbegin \DIFdel{Three key observations emerge: (1) modern LLMs can match or exceed a
trained GIS specialist on this task, (2) supplementing
gpt-4.1-2025-04-14 with explicit Google-Maps queries did not improve
accuracy---in fact, the tool-chain variant T-4 performed 30\% worse than
its pure-prompt counterpart, and (3) the amount of chain-of-thought the
...
%DIFDELCMD < %%%
\DIFdelend \subsection{Cost--Accuracy Trade-off}\label{costaccuracy-trade-off}
...
kilometers) for each method\DIFaddbegin \DIFadd{; numeric values appear in Table
\ref{tbl:cost}}\DIFaddend . All automated variants dominate the GIS script baseline
...
\DIFaddend \caption{\label{tbl:cost}Cost \DIFdelbegin \DIFdel{efficiency of evaluated
methods}\DIFdelend \DIFaddbegin \DIFadd{metrics by method---cost per 1,000 located
grants (USD) and mean error (km)}\DIFaddend .}\tabularnewline
\toprule\noalign{}
ID & Cost \DIFdelbegin \DIFdel{/ }\DIFdelend \DIFaddbegin \DIFadd{per 1,000 }\DIFaddend located (USD) & \DIFdelbegin \DIFdel{Cost per 1k }%DIFDELCMD < & %%%
\DIFdelend Mean error (km) \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
ID & Cost \DIFdelbegin \DIFdel{/ }\DIFdelend \DIFaddbegin \DIFadd{per 1,000 }\DIFaddend located (USD) & \DIFdelbegin \DIFdel{Cost per 1k }%DIFDELCMD < & %%%
...
\bottomrule\noalign{}
\endlastfoot
E-1 & \DIFdelbegin \DIFdel{0.19565 }%DIFDELCMD < & %%%
\DIFdelend 195.65 & \DIFdelbegin \DIFdel{18.7 }\DIFdelend \DIFaddbegin \DIFadd{19.2 }\DIFaddend \\
E-2 & \DIFdelbegin \DIFdel{0.20003 }%DIFDELCMD < & %%%
\DIFdelend 200.03 & \DIFdelbegin \DIFdel{20.4 }\DIFdelend \DIFaddbegin \DIFadd{20.6 }\DIFaddend \\
M-2 & \DIFdelbegin \DIFdel{0.12746 }%DIFDELCMD < & %%%
\DIFdelend 127.46 & 23.4 \\
M-5 & \DIFdelbegin \DIFdel{0.00105 }%DIFDELCMD < & %%%
\DIFdelend 1.05 & 27.9 \\
M-4 & \DIFdelbegin \DIFdel{0.00046 }%DIFDELCMD < & %%%
\DIFdelend 0.46 & 28.5 \\
T-4 & \DIFdelbegin \DIFdel{0.00323 }%DIFDELCMD < & %%%
\DIFdelend 3.23 & 37.2 \\
T-1 & \DIFdelbegin \DIFdel{0.01142 }%DIFDELCMD < & %%%
\DIFdelend 11.42 & 37.7 \\
M-1 & \DIFdelbegin \DIFdel{0.01069 }%DIFDELCMD < & %%%
\DIFdelend 10.69 & 41.7 \\
M-6 & \DIFdelbegin \DIFdel{0.00010 }%DIFDELCMD < & %%%
\DIFdelend 0.10 & 43.1 \\
M-3 & \DIFdelbegin \DIFdel{0.01415 }%DIFDELCMD < & %%%
\DIFdelend 14.15 & 50.3 \\
H-1 & \DIFdelbegin \DIFdel{3.25581 }%DIFDELCMD < & %%%
\DIFdelend 3,255.81 & 71.4 \\
H-2 & \DIFdelbegin \DIFdel{0.00000 }%DIFDELCMD < & %%%
\DIFdelend 0.00 & 79.0 \\
H-4 & \DIFdelbegin \DIFdel{0.00000 }%DIFDELCMD < & %%%
\DIFdelend 0.00 & 80.3 \\
H-3 & \DIFdelbegin \DIFdel{0.00000 }%DIFDELCMD < & %%%
\DIFdelend 0.00 & 94.3 \\
\end{longtable}
...
\caption{\DIFdelbeginFL \DIFdelFL{Cost-Accuracy Tradeoff}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Cost--accuracy Pareto frontier: mean error (km) versus cost per
1,000 located grants (USD). Points nearer the lower-left frontier
represent better cost--accuracy trade-offs.}\DIFaddendFL }\label{fig:pareto_cost}
\end{figure}
...
Examining the latency dimension, Figure \DIFdelbegin \DIFdel{\ref{fig:pareto_latency} }\DIFdelend \DIFaddbegin \DIFadd{\ref{fig:latency_box} }\DIFaddend shows that
...
\caption{\DIFdelbeginFL \DIFdelFL{Distribution of per-grant }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Per-grant }\DIFaddendFL latency by method \DIFaddbeginFL \DIFaddFL{(seconds; log-scale x-axis)}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{Boxplots show medians and interquartile ranges; whiskers indicate the 1.5 IQR range; outliers are omitted.}\DIFaddendFL }
...
thought for grant\_04 (\DIFdelbegin \DIFdel{``}\DIFdelend WILLIAM WILLIAMS) is distilled into key stages.
\DIFdelbegin \DIFdel{Table 4 shows these steps for the tool-chain (T-2) and one-shot (M-2)
methods. }\DIFdelend The full grant text shown to the model was:
...
\DIFaddbegin \caption{\label{tbl:grant04_steps}\DIFadd{Qualitative step‑by‑step comparison
...
Full reasoning chains are available in \DIFdelbegin \DIFdel{Section \ref{app-cot-trace}}\DIFdelend \DIFaddbegin \DIFadd{Appendix A.3}\DIFaddend .

The \emph{one-shot} paradigm \DIFdelbegin \DIFdel{asks the model to read the abstract, reason
...
mental triangulation against its latent world map, and
produces a
best-guess point estimate}\DIFdelend \DIFaddbegin \DIFadd{produces a single coordinate from the input
...
place names); no tool calls are issued}\DIFaddend . By contrast, the
\emph{tool-chain} paradigm externalises part of \DIFdelbegin \DIFdel{that reasoning}\DIFdelend \DIFaddbegin \DIFadd{the search process}\DIFaddend . The
...
and self-reflection can be slower and, as \DIFdelbegin \DIFdel{§ }\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 6.1 showed, not
necessarily more accurate.
\DIFdelbegin \DIFdel{Nevertheless, the traces
reveal }\emph{\DIFdel{why}} %DIFAUXCMD
\DIFdel{the model settles on a location---useful when
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1579}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1579}}@{}}
\caption{\label{tbl:tooluse}\DIFdelbegin \DIFdel{LLM tool-chain }\DIFdelend \DIFaddbegin \DIFadd{Tool‑chain }\DIFaddend behavior on the \DIFdelbegin \DIFdel{43-grant }\DIFdelend \DIFaddbegin \DIFadd{43‑grant }\DIFaddend test
\DIFdelbegin \DIFdel{set}\DIFdelend \DIFaddbegin \DIFadd{set---calls per entry (mean), geocode:centroid ratio, and first‑call
success rate}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Method
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
For both pipelines the Google \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!geocode\_place!}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{geocode\_place }\DIFaddend endpoint dominated the call
mix, whereas the auxiliary \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!compute\_centroid!} %%%
\DIFdelend \DIFaddbegin \DIFadd{compute\_centroid }\DIFaddend function appeared in fewer
than one call per ten. gpt-4.1-2025-04-14 (T-4) adopted a more
economical strategy, issuing on average \DIFdelbegin \DIFdel{2.3 }\DIFdelend \DIFaddbegin \DIFadd{2.23 }\DIFaddend calls per grant while
succeeding on the first query in \DIFdelbegin \DIFdel{73}\DIFdelend \DIFaddbegin \DIFadd{72.1}\DIFaddend \% of cases. The \DIFdelbegin \DIFdel{gpt-4o-mini-2025-04-16 }\DIFdelend \DIFaddbegin \DIFadd{o4-mini-2025-04-16
}\DIFaddend model (T-1), by contrast, averaged \DIFdelbegin \DIFdel{4.0 }\DIFdelend \DIFaddbegin \DIFadd{3.98 }\DIFaddend calls with a \DIFdelbegin \DIFdel{67}\DIFdelend \DIFaddbegin \DIFadd{66.7}\DIFaddend \% first-call
success rate. This greater query volume manifests as the higher token
usage and latency reported in \DIFdelbegin \DIFdel{§ }\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 6.3, yet it conferred no
observable advantage in positional accuracy (\DIFdelbegin \DIFdel{§ }\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 6.1).
...
\item
  ...
  Method rankings \DIFdelbegin \DIFdel{and 95\% CIs }\DIFdelend remain unchanged; only H-1 \citep{Bashorun2025_gis}
  (−6.6 km) and M-6 (−6.3 km) show material shifts\DIFdelbegin \DIFdel{, leaving M-2 as the top performer}\DIFdelend .
\item
  ...
  \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline![NAME]!}%%%
\DIFdelend \DIFaddbegin \texttt{[\DIFadd{NAME}]}\DIFaddend . If the model had memorised
  ...
  error rose only slightly---from \DIFdelbegin \DIFdel{18.7 km to 20.4 }\DIFdelend \DIFaddbegin \DIFadd{19.2 km to 20.6 }\DIFaddend km---and the ≤10 km
  hit-rate fell by just \DIFdelbegin \DIFdel{4.6 pp (39.5 → }\DIFdelend \DIFaddbegin \DIFadd{4.7 pp (}\DIFaddend 34.9 \DIFaddbegin \DIFadd{→ 30.2}\DIFaddend ). The mild degradation
  indicates that the model is drawing on the descriptive toponyms and
  spatial clues in the text rather than retrieving memorised locations\DIFdelbegin \DIFdel{,
  providing no evidence of leakage from the historical grants
  themselves}\DIFdelend .
\item
...
\caption{\DIFdelbeginFL \DIFdelFL{Length vs}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Abstract length versus error; tests whether longer texts
improve geolocation accuracy (no meaningful relationship
found)}\DIFaddendFL .\DIFdelbeginFL \DIFdelFL{~Error}\DIFdelendFL }\label{fig:length-vs-error}
\end{figure}

These results suggest that \DIFdelbegin \DIFdel{, within the 25--60-word range typical of the
corpus, }\DIFdelend abstract length explains essentially none of
...
integrated via DBSCAN clustering \DIFaddbegin \DIFadd{(MinPts = 3)}\DIFaddend , reduces mean error to
≈\DIFdelbegin \DIFdel{19 }\DIFdelend \DIFaddbegin \DIFadd{19.2 }\DIFaddend km, representing an 18\% accuracy improvement at a marginal
...
Even \DIFdelbegin \DIFdel{optimized }\DIFdelend \DIFaddbegin \DIFadd{the best-performing }\DIFaddend models occasionally yield significant
...
\DIFdelbegin \DIFdel{Leveraging models like gpt-4o-2024-08-06, which provide
...
\item
  ...
  additional failure channel: once the first \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!geocode\_place!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{geocode\_place}}
  \DIFaddend call returns a spurious coordinate, subsequent
  \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!compute\_centroid!}
%DIFDELCMD <   %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{compute\_centroid}} \DIFaddend operations often average anchors that are
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:grant19}
\end{subfigure}
\caption{Grant examples \DIFdelbeginFL \DIFdelFL{: Grant 1 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{comparing predicted points against ground truth }\DIFaddendFL (\DIFdelbeginFL \DIFdelFL{left}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{black stars}\DIFaddendFL )\DIFdelbeginFL \DIFdelFL{shows a }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{. Left: }\DIFaddendFL success case \DIFdelbeginFL \DIFdelFL{where the o3 model (M-2) and tool-chain gpt-4.1 (T-4) are }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{with }\DIFaddendFL close \DIFdelbeginFL \DIFdelFL{to ground truth. Grant 19 (}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{agreement; }\DIFaddendFL right\DIFdelbeginFL \DIFdelFL{) illustrates a }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{: }\DIFaddendFL failure mode where an early spurious geocoder hit \DIFdelbeginFL \DIFdelFL{sends }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{drives }\DIFaddendFL the tool-chain \DIFdelbeginFL \DIFdelFL{prediction }\DIFdelendFL far from ground truth \DIFdelbeginFL \DIFdelFL{, whereas }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{while }\DIFaddendFL the unguided model remains \DIFdelbeginFL \DIFdelFL{closer to the actual location}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{nearer}\DIFaddendFL . Basemap © OSM.}
\label{fig:grant_maps}
\end{figure}

\DIFaddbegin \DIFadd{Figure \ref{fig:grant_maps} juxtaposes two representative outcomes---one
success and one failure---to illustrate mechanism rather than anomaly.
}\DIFaddend In Grant 1 (LEWIS GREEN), language-only inference (M-2) achieves
...
them with DBSCAN (\DIFaddbegin \DIFadd{MinPts = 3; }\DIFaddend method E-1) pushes mean error down to
≈\DIFdelbegin \DIFdel{19 }\DIFdelend \DIFaddbegin \DIFadd{19.2 }\DIFaddend km at a per-grant cost of ≈\$0.20. Because the ensemble averages
...
\item
  \DIFaddbegin \textbf{\DIFadd{Model family scope.}} \DIFadd{We limit models to OpenAI's GPT/o‑series
  ...
  \DIFaddend \textbf{Tool bias.} Google's geocoder is optimised for modern place
...
\tightlist
\item
  \textbf{Corpus expansion.} \DIFdelbegin \DIFdel{Digitising }\DIFdelend \DIFaddbegin \DIFadd{Digitizing }\DIFaddend the remaining volumes of
...
\DIFaddbegin \item
  \textbf{\DIFadd{Compare to Google's geospatial agent stack.}} \DIFadd{A follow‑on study
...
reasoning effort and fused with DBSCAN \DIFaddbegin \DIFadd{(MinPts = 3)}\DIFaddend , reduces mean error
further to ≈\DIFdelbegin \DIFdel{19 }\DIFdelend \DIFaddbegin \DIFadd{19.2 }\DIFaddend km while adding only ≈US \$0.07 and three seconds per
...
\section{\DIFdelbegin \DIFdel{12 Acknowledgements}\DIFdelend \DIFaddbegin \DIFadd{Use of Artificial
Intelligence}\DIFaddend }\DIFaddbegin \label{use-of-artificial-intelligence}

\DIFadd{Claude 3.7 Sonnet was used for Python debugging, code generation, Matlab
...
\DIFadd{OpenAI o3 served as a methodological sounding board as well as Python
debugging.
}

\DIFadd{GPT 4.5 was used to rewrite portions of the final manuscript for clarity
and concision. All numerical data in model outputs were immediately
discarded.
}

\DIFadd{All AI-assisted processes, as well as the methodologies and findings,
...
\section{\DIFadd{Acknowledgements}}\DIFaddend \label{acknowledgements}
...
\DIFdelbegin \DIFdel{The authors also thank the Library of Virginia and the Virginia
...
\DIFdelbegin \DIFdel{Finally, the authors are indebted to the digital humanities community
whose ongoing conversations about LLMs and historical research have
informed this project's methodological approach.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Materials}%DIFDELCMD < }%%%
\DIFdelend \DIFaddbegin \appendix\section{\DIFadd{Supplementary Methods \&
Materials}}\DIFaddend \label{appendix-a-supplementary-methods-materials}

\subsection{OCR \& Text-Normalisation
Pipeline}\label{a.1-ocr-text-normalisation-pipeline}

The corpus preparation described in \DIFdelbegin \DIFdel{§}\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 3.2 comprised a multi-stage
...
Available tools
%DIF < • `geocode_place(query, strategy)`
%DIF > • geocode_place(query, strategy)
    – Look up a place name via the Google Geocoding API (Virginia-restricted).
%DIF <     – Returns JSON: `{lat, lng, formatted_address, strategy, query_used}`.
%DIF < • `compute_centroid(points)`
%DIF <     – Accepts **two or more** objects like `{lat: 37.1, lng: -76.7}` and returns their average.
%DIF >     – Returns JSON: {lat, lng, formatted_address, strategy, query_used}.
%DIF > • compute_centroid(points)
%DIF >     – Accepts **two or more** objects like {lat: 37.1, lng: -76.7} and returns their average.
...
%DIF < 1. Call `geocode_place` with that string. If the result is in the expected or an adjacent county *and* the feature lies in Virginia (or an NC border county), treat it as **plausible**. A matching feature keyword in `formatted_address` is *preferred* but not mandatory after several attempts.
%DIF > 1. Call geocode_place with that string. If the result is in the expected or an adjacent county *and* the feature lies in Virginia (or an NC border county), treat it as **plausible**. A matching feature keyword in formatted_address is *preferred* but not mandatory after several attempts.

%DIF < 2. If the first call is not plausible, iteratively refine the query (alternate spelling, nearby landmark, bordering county, etc.) and call `geocode_place` again until you obtain *at least one* plausible point **or** you have made six tool calls, whichever comes first.
%DIF > 2. If the first call is not plausible, iteratively refine the query (alternate spelling, nearby landmark, bordering county, etc.) and call geocode_place again until you obtain *at least one* plausible point **or** you have made six tool calls, whichever comes first.

%DIF < 3. Optional centroid use – if the grant text clearly places the tract *between* two or more natural features (e.g., "between the mouth of Cypress Swamp and Blackwater River") **or** you have two distinct plausible anchor points (creek-mouth, swamp, plantation), you may call `compute_centroid(points)` exactly once to average them. Otherwise skip this step.
%DIF > 3. Optional centroid use – if the grant text clearly places the tract *between* two or more natural features (e.g., "between the mouth of Cypress Swamp and Blackwater River") **or** you have two distinct plausible anchor points (creek-mouth, swamp, plantation), you may call compute_centroid(points) exactly once to average them. Otherwise skip this step.
...
%DIF < 5. Final answer – reply with **only** the coordinates in decimal degrees with six digits after the decimal point, e.g., `36.757059, -77.836728`. No explanatory text.
%DIF > 5. Final answer – reply with **only** the coordinates in decimal degrees with six digits after the decimal point, e.g., 36.757059, -77.836728. No explanatory text.

Important rules
%DIF < • Always perform at least one successful `geocode_place` call before any other tool.
%DIF < • Invoke `compute_centroid` only when you already have two or more plausible anchor points and averaging will help locate a "between" description.
%DIF > • Always perform at least one successful geocode_place call before any other tool.
%DIF > • Invoke compute_centroid only when you already have two or more plausible anchor points and averaging will help locate a "between" description.
• Never invent coordinates—derive them from tool output.
%DIF < • Return no explanatory text, symbols, or degree signs—just `lat, lon`.
%DIF > • Return no explanatory text, symbols, or degree signs—just lat, lon.
\end{lstlisting}
\DIFmodend
...
\DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!37.166303, -77.240091!}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{37.166303, -77.240091}}
\DIFaddend 
...
OpenAI \emph{Responses} request via the \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!tools!}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{tools}}
\DIFaddend parameter, allowing the model to emit
\DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!function\_call!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{function\_call}} \DIFaddend objects whose arguments are
validated and then executed by the evaluation driver. After execution
the Python backend streams a
\DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!function\_call\_output!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{function\_call\_output}} \DIFaddend item containing the
...
The driver maps the call to \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!google\_geocode()!}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{google\_geocode()}}
\DIFaddend with a hard-coded
\DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!components=administrative\_area:VA!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{components=administrative\_area:VA}} \DIFaddend filter,
discards results falling outside Virginia, and returns a trimmed JSON
object
\DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!\{lat, lng, formatted\_address, strategy, query\_used\}!}%%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{\{lat, lng, formatted\_address, strategy, query\_used\}}}\DIFaddend .
...
The backend converts each \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!(lat, lng)!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{(lat, lng)}} \DIFaddend pair to a
...
\item
  \emph{Invocation.} It emits a \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!function\_call!}
%DIFDELCMD <   %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{function\_call}}
  \DIFaddend with the chosen arguments. The evaluation script records the call for
  later provenance analysis.
\item
  \emph{Execution \& Observation.} The Python backend executes the call,
  returning a JSON payload as a
  \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!function\_call\_output!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{function\_call\_output}} \DIFaddend message appended to
  the conversation.
\item
  \emph{Reflection.} Reading the payload, the model either (i) issues a
  refined query, (ii) averages multiple anchors via
  \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!compute\_centroid!}%%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{compute\_centroid}}\DIFaddend , or (iii) produces a final
  coordinate string.
\end{enumerate}
...
\DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!run\_experiment.py!}%%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{run\_experiment.py}}\DIFaddend , which exposes a
reproducible command-line interface (CLI) for selecting the evaluation
set, method roster, and runtime flags (e.g.,
\DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!--dry-run!}%%%
\DIFdel{,
}%DIFDELCMD < \passthrough{\lstinline!--max-rows!}%%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{--dry-run}}\DIFadd{,
}\texttt{\DIFadd{--max-rows}}\DIFaddend ). The driver
...
\item
  ...
  \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!function\_call!} %%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{function\_call}} \DIFaddend requests to the tool back-end
  described above,
\item
  logs raw API traffic---including intermediate tool traces---to
  \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!runs/<method>/calls.jsonl!}%%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{runs/<method>/calls.jsonl}}\DIFaddend , and
\item
  emits both row-level results
  (\DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!results\_<evalset>.csv!}%%%
\DIFdelend \DIFaddbegin \texttt{\DIFadd{results\_<evalset>.csv}}\DIFaddend ) and a Markdown run
...
\DIFdelbegin \subsection{\DIFdel{Detailed Accuracy
Metrics}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{b.1-detailed-accuracy-metrics}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Table \ref{tbl:error_ci} provides comprehensive error statistics for each evaluated method, including confidence intervals derived from
bootstrap resampling (10,000 iterations). The best-performing automated
approach, M-2 (o3-2025-04-16), achieves a mean error of 23.39 kmwith a
95\% confidence interval of }%DIFDELCMD < {[}%%%
\DIFdel{17.57, 29.54}%DIFDELCMD < {]} %%%
\DIFdel{km}\DIFdelend \DIFaddbegin \DIFadd{Extended quantitative results and detailed performance metrics are
available in the supplementary repository at
}\href{[Repository URL removed for blind review]/blob/main/paper/APPENDIX_B_Extended_Results.md}{\DIFadd{github.com/ryanmio/colonial-virginia-llm-geolocation}}\DIFaddend .

\DIFdelbegin %DIFDELCMD < \begin{longtable}[]{@{}lllll@{}}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{tbl:error_ci}%%%
\DIFdel{Mean error with 95\% confidence intervals
for each method.}}%DIFAUXCMD
...
\DIFdel{n }%DIFDELCMD < & %%%
\DIFdel{Mean km }%DIFDELCMD < & %%%
\DIFdelend \DIFaddbegin \textbf{\DIFadd{Appendix B includes:}}

\begin{itemize}
\tightlist
\item
  \textbf{\DIFadd{B.1 Bootstrap Confidence Intervals:}} \DIFaddend 95\DIFdelbegin \DIFdel{\% CI }%DIFDELCMD < \\
%DIFDELCMD < \midrule\noalign{}
...
\DIFdel{n }%DIFDELCMD < & %%%
\DIFdel{Mean km }%DIFDELCMD < & %%%
\DIFdel{95\% CI }%DIFDELCMD < \\
%DIFDELCMD < \midrule\noalign{}
%DIFDELCMD < \endhead
%DIFDELCMD < \bottomrule\noalign{}
%DIFDELCMD < \endlastfoot
%DIFDELCMD < %%%
\DIFdel{E-1 }%DIFDELCMD < & %%%
\DIFdel{o3-2025-04-16 (ensemble) }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{19.24 }%DIFDELCMD < & {[}%%%
\DIFdel{13.60, 24.97}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{E-2 }%DIFDELCMD < & %%%
\DIFdel{ensemble name-redacted }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{20.57 }%DIFDELCMD < & {[}%%%
\DIFdel{15.08}\DIFdelend \DIFaddbegin \DIFadd{\% CIs for mean error
  across all methods, computed via 10}\DIFaddend ,\DIFdelbegin \DIFdel{26.83}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{H-1 }%DIFDELCMD < & %%%
\DIFdel{GIS analyst baseline }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{71.40 }%DIFDELCMD < & {[}%%%
\DIFdel{59.14}\DIFdelend \DIFaddbegin \DIFadd{000-iteration bootstrap resampling
}\item
  \textbf{\DIFadd{B.2 Complete Performance Tables:}} \DIFadd{Per-method accuracy metrics
  at 1 km}\DIFaddend , \DIFdelbegin \DIFdel{85.11}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{H-2 }%DIFDELCMD < & %%%
\DIFdel{Stanford NER (GeoTxt) }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{79.02 }%DIFDELCMD < & {[}%%%
\DIFdel{56.32}\DIFdelend \DIFaddbegin \DIFadd{5 km}\DIFaddend , \DIFdelbegin \DIFdel{109.38}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{H-3 }%DIFDELCMD < & %%%
\DIFdel{Mordecai-3 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{94.28 }%DIFDELCMD < & {[}%%%
\DIFdel{68.81, 124.61}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{H-4 }%DIFDELCMD < & %%%
\DIFdel{County Centroid }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{80.33 }%DIFDELCMD < & {[}%%%
\DIFdel{65.96, 95.88}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{M-1 }%DIFDELCMD < & %%%
\DIFdel{o4-mini-2025-04-16 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{41.65 }%DIFDELCMD < & {[}%%%
\DIFdel{33.77, 50.11}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{M-2 }%DIFDELCMD < & %%%
\DIFdel{o3-2025-04-16 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{23.39 }%DIFDELCMD < & {[}%%%
\DIFdel{17.37, 29.25}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{M-3 }%DIFDELCMD < & %%%
\DIFdel{o3-mini-2025-01-31 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{50.25 }%DIFDELCMD < & {[}%%%
\DIFdel{43.02, 58.63}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{M-4 }%DIFDELCMD < & %%%
\DIFdel{gpt-4.1-2025-04-14 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{28.51 }%DIFDELCMD < & {[}%%%
\DIFdel{22.68, 35.10}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{M-5 }%DIFDELCMD < & %%%
\DIFdel{gpt-4o-2024-08-06 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{27.93 }%DIFDELCMD < & {[}%%%
\DIFdel{22.31, 33.85}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{M-6 }%DIFDELCMD < & %%%
\DIFdel{gpt-3.5-turbo }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{43.05 }%DIFDELCMD < & {[}%%%
\DIFdel{33.78, 53.98}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{T-1 }%DIFDELCMD < & %%%
\DIFdel{o4-mini-2025-04-16 + tools }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{37.65 }%DIFDELCMD < & {[}%%%
\DIFdel{30.86, 44.99}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{T-4 }%DIFDELCMD < & %%%
\DIFdel{gpt-4.1-2025-04-14 + tools }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{37.23 }%DIFDELCMD < & {[}%%%
\DIFdel{30.11, 45.03}%DIFDELCMD < {]} \\
%DIFDELCMD < \end{longtable}
%DIFDELCMD < 

%DIFDELCMD < %%%
\subsection{\DIFdel{Performance by
Method}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{b.2-performance-by-method}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Table \ref{tbl:method_performance} provides the complete performance
...
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 22\tabcolsep) * \real{0.0833}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 22\tabcolsep) * \real{0.0833}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 22\tabcolsep) * \real{0.0833}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 22\tabcolsep) * \real{0.0833}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 22\tabcolsep) * \real{0.0833}}
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{tbl:method_performance}%%%
\DIFdel{Detailed performance metrics by
method.}}%DIFAUXCMD
%DIFDELCMD < \tabularnewline
%DIFDELCMD < \toprule\noalign{}
...
%DIFDELCMD < %%%
\DIFdel{≤}\DIFdelend 10 km\DIFdelbegin %DIFDELCMD < \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{≤}\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend 25 km\DIFdelbegin %DIFDELCMD < \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{≤}\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend 50 km\DIFdelbegin %DIFDELCMD < \end{minipage} \\
%DIFDELCMD < \midrule\noalign{}
%DIFDELCMD < \endfirsthead
%DIFDELCMD < \toprule\noalign{}
%DIFDELCMD < \begin{minipage}[b]{\linewidth}\raggedright
...
\DIFdel{E-1 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{18.71 }%DIFDELCMD < & %%%
\DIFdel{12.45 }%DIFDELCMD < & %%%
\DIFdel{19.36 }%DIFDELCMD < & %%%
\DIFdel{1.77 }%DIFDELCMD < & %%%
\DIFdel{5.60 }%DIFDELCMD < & %%%
\DIFdel{23.87 }%DIFDELCMD < & %%%
\DIFdel{100.90 }%DIFDELCMD < & %%%
\DIFdel{39.5\%
}%DIFDELCMD < & %%%
\DIFdel{76.7\% }%DIFDELCMD < & %%%
\DIFdel{95.3\% }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{E-2 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{20.44 }%DIFDELCMD < & %%%
\DIFdel{13.75 }%DIFDELCMD < & %%%
\DIFdel{18.87 }%DIFDELCMD < & %%%
\DIFdel{1.11 }%DIFDELCMD < & %%%
\DIFdel{7.41 }%DIFDELCMD < & %%%
\DIFdel{24.05 }%DIFDELCMD < & %%%
\DIFdel{95.34 }%DIFDELCMD < & %%%
\DIFdel{34.9\%
}%DIFDELCMD < & %%%
\DIFdel{76.7\% }%DIFDELCMD < & %%%
\DIFdel{95.3\% }%DIFDELCMD < \\
...
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{71.40 }%DIFDELCMD < & %%%
\DIFdel{60.20 }%DIFDELCMD < & %%%
\DIFdel{45.65 }%DIFDELCMD < & %%%
\DIFdel{5.98 }%DIFDELCMD < & %%%
\DIFdel{30.63 }%DIFDELCMD < & %%%
\DIFdel{117.50 }%DIFDELCMD < & %%%
\DIFdel{170.95 }%DIFDELCMD < &
%DIFDELCMD < %%%
\DIFdel{4.7\% }%DIFDELCMD < & %%%
\DIFdel{18.6\% }%DIFDELCMD < & %%%
\DIFdel{41.9\% }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{H-2 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{79.02 }%DIFDELCMD < & %%%
\DIFdel{59.45 }%DIFDELCMD < & %%%
\DIFdel{88.32 }%DIFDELCMD < & %%%
\DIFdel{2.29 }%DIFDELCMD < & %%%
\DIFdel{29.05 }%DIFDELCMD < & %%%
\DIFdel{94.67 }%DIFDELCMD < & %%%
\DIFdel{448.66 }%DIFDELCMD < & %%%
\DIFdel{7.0\%
}%DIFDELCMD < & %%%
\DIFdel{23.3\% }%DIFDELCMD < & %%%
\DIFdel{41.9\% }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{H-3 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{94.28 }%DIFDELCMD < & %%%
\DIFdel{55.45 }%DIFDELCMD < & %%%
\DIFdel{91.73 }%DIFDELCMD < & %%%
\DIFdel{5.20 }%DIFDELCMD < & %%%
\DIFdel{30.63 }%DIFDELCMD < & %%%
\DIFdel{123.12 }%DIFDELCMD < & %%%
\DIFdel{383.18 }%DIFDELCMD < &
%DIFDELCMD < %%%
\DIFdel{7.0\% }%DIFDELCMD < & %%%
\DIFdel{20.9\% }%DIFDELCMD < & %%%
\DIFdel{41.9\% }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{H-4 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{80.33 }%DIFDELCMD < & %%%
\DIFdel{70.49 }%DIFDELCMD < & %%%
\DIFdel{51.46 }%DIFDELCMD < & %%%
\DIFdel{2.46 }%DIFDELCMD < & %%%
\DIFdel{36.82 }%DIFDELCMD < & %%%
\DIFdel{125.61 }%DIFDELCMD < & %%%
\DIFdel{187.61 }%DIFDELCMD < &
%DIFDELCMD < %%%
\DIFdel{4.7\% }%DIFDELCMD < & %%%
\DIFdel{11.6\% }%DIFDELCMD < & %%%
\DIFdel{37.2\% }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{M-1 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{41.65 }%DIFDELCMD < & %%%
\DIFdel{27.39 }%DIFDELCMD < & %%%
\DIFdel{27.32 }%DIFDELCMD < & %%%
\DIFdel{7.59 }%DIFDELCMD < & %%%
\DIFdel{18.45 }%DIFDELCMD < & %%%
\DIFdel{70.04 }%DIFDELCMD < & %%%
\DIFdel{103.49 }%DIFDELCMD < & %%%
\DIFdel{7.0\%
}%DIFDELCMD < & %%%
\DIFdel{37.2\% }%DIFDELCMD < & %%%
\DIFdel{62.8\% }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{M-2 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{23.39 }%DIFDELCMD < & %%%
\DIFdel{14.27 }%DIFDELCMD < & %%%
\DIFdel{19.86 }%DIFDELCMD < & %%%
\DIFdel{2.67 }%DIFDELCMD < & %%%
\DIFdel{8.17 }%DIFDELCMD < & %%%
\DIFdel{36.85 }%DIFDELCMD < & %%%
\DIFdel{87.35 }%DIFDELCMD < & %%%
\DIFdel{30.2\%
}%DIFDELCMD < & %%%
\DIFdel{60.5\% }%DIFDELCMD < & %%%
\DIFdel{93.0\% }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{M-3 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{50.25 }%DIFDELCMD < & %%%
\DIFdel{48.40 }%DIFDELCMD < & %%%
\DIFdel{24.93 }%DIFDELCMD < & %%%
\DIFdel{6.29 }%DIFDELCMD < & %%%
\DIFdel{27.36 }%DIFDELCMD < & %%%
\DIFdel{69.53 }%DIFDELCMD < & %%%
\DIFdel{123.04 }%DIFDELCMD < & %%%
\DIFdel{4.7\%
}%DIFDELCMD < & %%%
\DIFdel{16.3\% }%DIFDELCMD < & %%%
\DIFdel{53.5\% }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{M-4 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{28.51 }%DIFDELCMD < & %%%
\DIFdel{25.42 }%DIFDELCMD < & %%%
\DIFdel{20.77 }%DIFDELCMD < & %%%
\DIFdel{2.14 }%DIFDELCMD < & %%%
\DIFdel{12.09 }%DIFDELCMD < & %%%
\DIFdel{40.49 }%DIFDELCMD < & %%%
\DIFdel{98.72 }%DIFDELCMD < & %%%
\DIFdel{20.9\%
}%DIFDELCMD < & %%%
\DIFdel{48.8\% }%DIFDELCMD < & %%%
\DIFdel{86.0\% }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{M-5 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{27.93 }%DIFDELCMD < & %%%
\DIFdel{24.97 }%DIFDELCMD < & %%%
\DIFdel{19.46 }%DIFDELCMD < & %%%
\DIFdel{3.03 }%DIFDELCMD < & %%%
\DIFdel{14.66 }%DIFDELCMD < & %%%
\DIFdel{37.25 }%DIFDELCMD < & %%%
\DIFdel{98.86 }%DIFDELCMD < & %%%
\DIFdel{16.3\%
}%DIFDELCMD < & %%%
\DIFdel{51.2\% }%DIFDELCMD < & %%%
\DIFdel{90.7\% }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{M-6 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{43.05 }%DIFDELCMD < & %%%
\DIFdel{34.02 }%DIFDELCMD < & %%%
\DIFdel{36.07 }%DIFDELCMD < & %%%
\DIFdel{5.17 }%DIFDELCMD < & %%%
\DIFdel{17.11 }%DIFDELCMD < & %%%
\DIFdel{49.74 }%DIFDELCMD < & %%%
\DIFdel{176.33 }%DIFDELCMD < & %%%
\DIFdel{4.7\%
}%DIFDELCMD < & %%%
...
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{37.65 }%DIFDELCMD < & %%%
\DIFdel{33.61 }%DIFDELCMD < & %%%
\DIFdel{24.54 }%DIFDELCMD < & %%%
\DIFdel{0.59 }%DIFDELCMD < & %%%
\DIFdel{18.57 }%DIFDELCMD < & %%%
\DIFdel{62.30 }%DIFDELCMD < & %%%
\DIFdel{110.19 }%DIFDELCMD < &
%DIFDELCMD < %%%
\DIFdel{14.0\% }%DIFDELCMD < & %%%
\DIFdel{32.6\% }%DIFDELCMD < & %%%
\DIFdel{69.8\% }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{T-4 }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{37.23 }%DIFDELCMD < & %%%
\DIFdel{34.22 }%DIFDELCMD < & %%%
\DIFdel{23.94 }%DIFDELCMD < & %%%
\DIFdel{0.59 }%DIFDELCMD < & %%%
\DIFdel{21.78 }%DIFDELCMD < & %%%
\DIFdel{53.35 }%DIFDELCMD < & %%%
\DIFdel{101.85 }%DIFDELCMD < &
%DIFDELCMD < %%%
\DIFdel{16.3\% }%DIFDELCMD < & %%%
\DIFdel{32.6\% }%DIFDELCMD < & %%%
\DIFdel{74.4\% }%DIFDELCMD < \\
%DIFDELCMD < \end{longtable}
%DIFDELCMD < 

%DIFDELCMD < %%%
\subsection{\DIFdel{Cost-Accuracy
Trade-off}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{b.3-cost-accuracy-trade-off}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Table \ref{tbl:cost_accuracy} examines the cost-accuracy relationship, emphasizing the economic efficiency of gpt-4o-2024-08-06, which achieves
near-top performance at just \$1.05 per 1}\DIFdelend , \DIFdelbegin \DIFdel{000 grants processed. ``Cost
per +}\DIFdelend \DIFaddbegin \DIFadd{and 161 km thresholds with full
  distributional statistics (mean, median, SD, quartiles)
}\item
  \textbf{\DIFadd{B.3 Cost-Accuracy Analysis:}} \DIFadd{Detailed cost per grant and cost
  per }\DIFaddend 1\DIFdelbegin \DIFdel{\% ≤10 km hit'' indicates the marginal cost of improving
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{tbl:cost_accuracy}%%%
\DIFdel{Cost-accuracy trade-off by model
family.}}%DIFAUXCMD
%DIFDELCMD < \tabularnewline
%DIFDELCMD < \toprule\noalign{}
%DIFDELCMD < \begin{minipage}[b]{\linewidth}\raggedright
...
%DIFDELCMD < %%%
\DIFdel{Mean error km
}%DIFDELCMD < \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{≤10 km hit-rate
}%DIFDELCMD < \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{Cost per 1k located (USD)
}%DIFDELCMD < \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{Cost per +1\% ≤10 km hit (USD)
}%DIFDELCMD < \end{minipage} \\
%DIFDELCMD < \midrule\noalign{}
%DIFDELCMD < \endfirsthead
%DIFDELCMD < \toprule\noalign{}
...
\DIFdel{o3-2025-04-16 (Ensemble) }%DIFDELCMD < & %%%
\DIFdel{18.71 }%DIFDELCMD < & %%%
\DIFdel{39.5\% }%DIFDELCMD < & %%%
\DIFdel{\$195.65 }%DIFDELCMD < & %%%
\DIFdel{\$4.95 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{o3-2025-04-16 }%DIFDELCMD < & %%%
\DIFdel{23.39 }%DIFDELCMD < & %%%
\DIFdel{30.2\% }%DIFDELCMD < & %%%
\DIFdel{\$127.46 }%DIFDELCMD < & %%%
\DIFdel{\$4.22 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{gpt-4o-2024-08-06 }%DIFDELCMD < & %%%
\DIFdel{27.93 }%DIFDELCMD < & %%%
\DIFdel{16.3\% }%DIFDELCMD < & %%%
\DIFdel{\$1.05 }%DIFDELCMD < & %%%
\DIFdel{\$0.06 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{gpt-4.1-2025-04-14 }%DIFDELCMD < & %%%
\DIFdel{32.87 }%DIFDELCMD < & %%%
\DIFdel{18.6\% }%DIFDELCMD < & %%%
\DIFdel{\$3.49 }%DIFDELCMD < & %%%
\DIFdel{\$0.19 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{o4-mini-2025-04-16 }%DIFDELCMD < & %%%
\DIFdel{39.65 }%DIFDELCMD < & %%%
\DIFdel{10.5\% }%DIFDELCMD < & %%%
\DIFdel{\$10.69 }%DIFDELCMD < & %%%
...
\DIFdel{50.25 }%DIFDELCMD < & %%%
\DIFdel{4.7\% }%DIFDELCMD < & %%%
\DIFdel{\$14.15 }%DIFDELCMD < & %%%
\DIFdel{\$3.04 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{human-gis }%DIFDELCMD < & %%%
\DIFdel{71.40 }%DIFDELCMD < & %%%
\DIFdel{4.7\% }%DIFDELCMD < & %%%
\DIFdel{\$3, 255.81 }%DIFDELCMD < & %%%
\DIFdel{\$700.00 }%DIFDELCMD < \\
%DIFDELCMD < \end{longtable}
%DIFDELCMD < 

%DIFDELCMD < %%%
\subsection{\DIFdel{Processing Time
Analysis}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{b.4-processing-time-analysis}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Table \ref{tbl:time_usage} quantifies the latency advantage of automated
methods over traditional GIS workflows. ``Speedup'' shows relative
improvement over the traditional GIS baseline.
}%DIFDELCMD < 

%DIFDELCMD < \begin{longtable}[]{@{}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}@{}}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{tbl:time_usage}%%%
\DIFdel{Processing time by model.}}%DIFAUXCMD
%DIFDELCMD < \tabularnewline
%DIFDELCMD < \toprule\noalign{}
%DIFDELCMD < \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
...
%DIFDELCMD < %%%
\DIFdel{Hours per located
}%DIFDELCMD < \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{Hours per 1k located
}%DIFDELCMD < \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{Speedup vs.~baseline
}%DIFDELCMD < \end{minipage} \\
%DIFDELCMD < \midrule\noalign{}
%DIFDELCMD < \endfirsthead
%DIFDELCMD < \toprule\noalign{}
...
\DIFdel{12.819 }%DIFDELCMD < & %%%
\DIFdel{17× }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{gpt-4o-2024-08-06 }%DIFDELCMD < & %%%
\DIFdel{0.0002 }%DIFDELCMD < & %%%
\DIFdel{0.178 }%DIFDELCMD < & %%%
\DIFdel{1, 219× }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{gpt-3.5-turbo }%DIFDELCMD < & %%%
\DIFdel{0.0002 }%DIFDELCMD < & %%%
\DIFdel{0.225 }%DIFDELCMD < & %%%
\DIFdel{964× }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{gpt-4.1-2025-04-14 }%DIFDELCMD < & %%%
\DIFdel{0.0003 }%DIFDELCMD < & %%%
\DIFdel{0.295 }%DIFDELCMD < & %%%
\DIFdel{736× }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{o3-2025-04-16 }%DIFDELCMD < & %%%
\DIFdel{0.0121 }%DIFDELCMD < & %%%
\DIFdel{12.060 }%DIFDELCMD < & %%%
\DIFdel{18× }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{o3-mini-2025-01-31 }%DIFDELCMD < & %%%
\DIFdel{0.0085 }%DIFDELCMD < & %%%
\DIFdel{8.523 }%DIFDELCMD < & %%%
\DIFdel{25× }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{o4-mini-2025-04-16 }%DIFDELCMD < & %%%
\DIFdel{0.0091 }%DIFDELCMD < & %%%
\DIFdel{9.145 }%DIFDELCMD < & %%%
\DIFdel{24× }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{human-gis }%DIFDELCMD < & %%%
\DIFdel{0.2170 }%DIFDELCMD < & %%%
\DIFdel{216.977 }%DIFDELCMD < & %%%
\DIFdel{1× }%DIFDELCMD < \\
%DIFDELCMD < \end{longtable}
%DIFDELCMD < 

%DIFDELCMD < %%%
\subsection{\DIFdel{Token Usage
Statistics}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{b.5-token-usage-statistics}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Table \ref{tbl:token_usage} provides detailed token consumption data
across all models, offering insight into computational efficiency.
}%DIFDELCMD < 

%DIFDELCMD < \begin{longtable}[]{@{}llll@{}}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{tbl:token_usage}%%%
\DIFdel{Token consumption by model across all
test runs.}}%DIFAUXCMD
%DIFDELCMD < \tabularnewline
%DIFDELCMD < \toprule\noalign{}
%DIFDELCMD < %%%
\DIFdel{Model }%DIFDELCMD < & %%%
\DIFdel{Input tokens }%DIFDELCMD < & %%%
\DIFdel{Output tokens }%DIFDELCMD < & %%%
\DIFdel{Tokens per 1k located }%DIFDELCMD < \\
%DIFDELCMD < \midrule\noalign{}
%DIFDELCMD < \endfirsthead
%DIFDELCMD < \toprule\noalign{}
%DIFDELCMD < %%%
...
%DIFDELCMD < %%%
\DIFdel{o3-2025-04-16 (Ensemble) }%DIFDELCMD < & %%%
\DIFdel{33}\DIFdelend ,\DIFdelbegin \DIFdel{265 }%DIFDELCMD < & %%%
\DIFdel{210,681 }%DIFDELCMD < & %%%
\DIFdel{10,441,907 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{gpt-4o-2024-08-06 }%DIFDELCMD < & %%%
\DIFdel{6,698 }%DIFDELCMD < & %%%
\DIFdel{900 }%DIFDELCMD < & %%%
\DIFdel{176,698 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{gpt-3.5-turbo }%DIFDELCMD < & %%%
\DIFdel{6,773 }%DIFDELCMD < & %%%
\DIFdel{820 }%DIFDELCMD < & %%%
\DIFdel{176,581 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{gpt-4.1-2025-04-14 }%DIFDELCMD < & %%%
\DIFdel{142,258 }%DIFDELCMD < & %%%
\DIFdel{4,193 }%DIFDELCMD < & %%%
\DIFdel{1,702,919 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{o3-2025-04-16 }%DIFDELCMD < & %%%
\DIFdel{6,653 }%DIFDELCMD < & %%%
\DIFdel{146,085 }%DIFDELCMD < & %%%
\DIFdel{6,923,209 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{o3-mini-2025-01-31 }%DIFDELCMD < & %%%
\DIFdel{6,653 }%DIFDELCMD < & %%%
\DIFdel{142,020 }%DIFDELCMD < & %%%
\DIFdel{6,739,372 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{o4-mini-2025-04-16 }%DIFDELCMD < & %%%
\DIFdel{274,903 }%DIFDELCMD < & %%%
\DIFdel{146,590 }%DIFDELCMD < & %%%
\DIFdel{6,340,337 }%DIFDELCMD < \\
%DIFDELCMD < \end{longtable}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Tool-augmented methods consumed on average 1.49× more tokens than
pure-prompt counterparts (4,985,953 vs.~3,355,078 tokens per 1,}\DIFdelend 000 located grants\DIFdelbegin \DIFdel{). However, this effect varied dramatically by model
architecture: adding tools to gpt-4.1-2025-04-14 increased token usage
by 18.3× (176, 698 → 3, 229}\DIFdelend , \DIFdelbegin \DIFdel{140), while o4-mini showed only a 1.14×
increase (5}\DIFdelend \DIFaddbegin \DIFadd{with Pareto-optimal method identification
}\item
  \textbf{\DIFadd{B.4 Latency Breakdowns:}} \DIFadd{Processing time distributions
  including API response latency, tool-call overhead, and total
  wall-clock time
}\item
  \textbf{\DIFadd{B.5 Token Usage Statistics:}} \DIFadd{Input/output token consumption by
  method and model, with implications for batch processing costs
}\item
  \textbf{\DIFadd{B.6 Professional GIS Benchmark:}} \DIFadd{Expanded discussion of
  single-analyst baseline methodology, time investment (8.2 hours for 43
  grants)}\DIFaddend , \DIFdelbegin \DIFdel{937,907 → 6,742,767).
}\DIFdelend \DIFaddbegin \DIFadd{and generalizability considerations
}\end{itemize}
\DIFaddend 

\DIFdelbegin \subsection{\DIFdel{Professional GIS Benchmark
Analysis}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{b.6-professional-gis-benchmark-analysis}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Table \ref{tbl:human_benchmark} provides a more detailed analysis of the
professional GIS benchmark (H-1) \mbox{%DIFAUXCMD
\citep{Bashorun2025_gis} }\hskip0pt%DIFAUXCMD
results,
categorized by
  precision level. This breakdown reveals that even with
expert domain knowledge and access to specialized historical gazetteers, more than 41.9\% of
  the human-geocoded grants were located at only
...
%DIFDELCMD < \begin{longtable}[]{@{}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.3684}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1579}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1579}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1579}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1579}}@{}}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{tbl:human_benchmark}%%%
\DIFdel{Professional GIS benchmark results
by accuracy category.}}%DIFAUXCMD
%DIFDELCMD < \tabularnewline
%DIFDELCMD < \toprule\noalign{}
%DIFDELCMD < \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{Accuracy Category
}%DIFDELCMD < \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{N
}%DIFDELCMD < \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
%DIFDELCMD < \endlastfoot
%DIFDELCMD < %%%
\DIFdel{Overall }%DIFDELCMD < & %%%
\DIFdel{43 }%DIFDELCMD < & %%%
\DIFdel{100.0 }%DIFDELCMD < & %%%
\DIFdel{71.40 }%DIFDELCMD < & %%%
\DIFdel{60.20 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{High (County + Landmarks)}%DIFDELCMD < & %%%
\DIFdel{19 }%DIFDELCMD < & %%%
\DIFdel{44.2 }%DIFDELCMD < & %%%
\DIFdel{68.88 }%DIFDELCMD < & %%%
\DIFdel{48.09 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{Medium (County centroid) }%DIFDELCMD < & %%%
\DIFdel{6 }%DIFDELCMD < & %%%
\DIFdel{14.0 }%DIFDELCMD < & %%%
\DIFdel{87.95 }%DIFDELCMD < & %%%
\DIFdel{82.11 }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{Low (State-level) }%DIFDELCMD < & %%%
\DIFdel{18 }%DIFDELCMD < & %%%
\DIFdel{41.9 }%DIFDELCMD < & %%%
\DIFdel{68.55 }%DIFDELCMD < & %%%
\DIFdel{63.26 }%DIFDELCMD < \\
%DIFDELCMD < \end{longtable}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Notably, even the ``High'' precision category (where both county
...
%DIFDELCMD < %%%
\DIFdelend \section{Supplementary
Figures}\label{appendix-c-supplementary-figures}

\DIFdelbegin \subsection{\DIFdel{Error Distribution
Plots}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{c.1-error-distribution-plots}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{Additional visualizations and geographic error maps are available in the
supplementary repository at
}\href{[Repository URL removed for blind review]/blob/main/paper/APPENDIX_C_Supplementary_Figures.md}{\DIFadd{github.com/ryanmio/colonial-virginia-llm-geolocation}}\DIFadd{.
}\DIFaddend 

\DIFdelbegin \DIFdel{Figure \ref{fig:error_boxplot} shows the distribution of geolocation
error for each method as a boxplot, complementing the violin plot and CDF already presented in the
main text.
The boxplot highlights the
...
}\DIFdelend \DIFaddbegin \textbf{\DIFadd{Appendix C includes:}}
\DIFaddend 

\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{figures/error_boxplot.pdf}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Error Distribution Boxplot by Method}}%DIFAUXCMD
%DIFDELCMD < \label{fig:error_boxplot}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < %%%
\subsection{\DIFdel{Error Maps}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{c.2-error-maps}
%DIFDELCMD < 

%DIFDELCMD < \begin{figure}
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{figures/contact_sheet.png}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Grid view of all 43 mapped grants showing ground truth and
predictions.}}%DIFAUXCMD
%DIFDELCMD < \label{fig:contactsheet}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Figure \ref{fig:contactsheet} plots all six methodsfor every locatable
...
%DIFDELCMD < %%%
\subsection{\DIFdel{Marginal Cost of High-Precision
Accuracy}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{c.3-marginal-cost-of-high-precision-accuracy}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Table \ref{tbl:cost_marginal} reports how many U.S. dollars each method
...
mean-error }\DIFdelend \DIFaddbegin \begin{itemize}
\tightlist
\item
  \textbf{\DIFadd{C.1 Error Distribution Plots:}} \DIFadd{Violin plots and boxplots
  showing error distributions for all methods, including outlier
  identification and quartile ranges
}\item
  \textbf{\DIFadd{C.2 Geographic Error Maps:}} \DIFadd{45-grant contact sheet displaying
  predicted }\DIFaddend vs.~\DIFdelbegin \DIFdel{cost Pareto plot in the main text: it quantifies the
price of }\emph{\DIFdel{high-confidence}} %DIFAUXCMD
\DIFdel{geocoding rather than average error alone.
}%DIFDELCMD < 
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{tbl:cost_marginal}%%%
\DIFdel{Marginal cost to improve the ≤10 km
hit-rate by one percentage point.}}%DIFAUXCMD
%DIFDELCMD < \tabularnewline
%DIFDELCMD < \toprule\noalign{}
%DIFDELCMD < \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{ground-truth coordinates on base maps, with color-coded
  error magnitude for spatial pattern analysis
}\item
  \textbf{\DIFadd{C.3 Marginal Cost Analysis:}} \DIFadd{Cost-effectiveness curves showing
  marginal USD investment required to achieve }\DIFaddend ≤10 km \DIFdelbegin \DIFdel{hit-rate
}%DIFDELCMD < \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{Cost per 1 k located (USD )
}%DIFDELCMD < \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{Cost per +1 \% ≤10 km hit (USD)
}%DIFDELCMD < \end{minipage} \\
...
\DIFdel{human-gis }%DIFDELCMD < & %%%
\DIFdel{4.7 \% }%DIFDELCMD < & %%%
\DIFdel{\$3}\DIFdelend \DIFaddbegin \DIFadd{accuracy across
  method tiers
}\item
  \textbf{\DIFadd{C.4 Latency-Accuracy Pareto Front:}} \DIFadd{Scatter plot of mean error
  vs.~processing time}\DIFaddend , \DIFdelbegin \DIFdel{255.81 }%DIFDELCMD < & %%%
\DIFdel{\$700.00 }%DIFDELCMD < \\
%DIFDELCMD < \end{longtable}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{identifying efficient frontier methods for
  time-constrained applications
}\end{itemize}
\DIFaddend 

\DIFdelbegin \DIFdel{The numbers reveal why }\textbf{\DIFdel{gpt-4o-2024-08-06}} %DIFAUXCMD
\DIFdel{is so attractive in
...
magnitude cheaper than even the }\emph{\DIFdel{o3}} %DIFAUXCMD
\DIFdel{ensemble, and over 10,000 ×
cheaper than a professional GIS analyst.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\subsection{\DIFdel{Latency-Accuracy
Tradeoff}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{c.4-latency-accuracy-tradeoff}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Processing time presents another critical dimension for evaluation. The
...
%DIFDELCMD < \begin{figure}
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{figures/pareto_latency_tradeoff.pdf}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Latency-Accuracy Tradeoff}}%DIFAUXCMD
%DIFDELCMD < \label{fig:pareto_latency}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Figure \ref{fig:pareto_latency}: Latency-Accuracy Tradeoff. This figure
plots mean error
  (km) against processing timeper grant (seconds) for
...
%DIFDELCMD < %%%
\DIFdelend \section{Tool Augmentation
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 22\tabcolsep) * \real{0.0732}}
  >{\raggedright\arraybackslash}p{(\linewidth - 22\tabcolsep) * \real{0.0732}}@{}}
\caption{\label{tbl:tool_direct_comparison}\DIFdelbegin \DIFdel{Side-by-side comparison of
identical }\DIFdelend \DIFaddbegin \DIFadd{Identical }\DIFaddend models with and
without tool access\DIFaddbegin \DIFadd{; isolates the effect of tools}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
mean
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\DIFdelbegin \DIFdel{median
}\DIFdelend \DIFaddbegin \DIFadd{med
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1071}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1071}}@{}}
\caption{\label{tbl:tool_effect}\DIFdelbegin \DIFdel{Quantified effect }\DIFdelend \DIFaddbegin \DIFadd{Effect }\DIFaddend of tool augmentation \DIFaddbegin \DIFadd{(Δ on mean
error and accuracy bands)}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}
  >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}@{}}
\caption{\label{tbl:best_methods}\DIFdelbegin \DIFdel{Best-performing methods per
category}\DIFdelend \DIFaddbegin \DIFadd{Head‑to‑head of best non‑tool vs best
tool‑augmented method}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Method
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\DIFdelbegin \DIFdel{metrics}\DIFdelend \DIFaddbegin \DIFadd{(selected‑call index; first‑call success)}\DIFaddend .}\tabularnewline
\toprule\noalign{}
...
\DIFdelbegin \subsubsection{\DIFdel{E.1 Appendix E Leakage
Audit}}%DIFAUXCMD
\addtocounter{subsubsection}{-1}%DIFAUXCMD
%DIFDELCMD < \label{e.1-appendix-e-leakage-audit}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \section{\DIFadd{Leakage Audit}}\label{appendix-e-leakage-audit}
\DIFaddend 
