...
\appendix
\section{Supplementary Methods \& Materials}\label{appendix-a-supplementary-methods-materials}
...
\section{Extended Results}\label{appendix-b-extended-results}

\subsection{Detailed Accuracy Metrics}\label{b.1-detailed-accuracy-metrics}
...
\subsection{Performance by Method}\label{b.2-performance-by-method}
...
\subsection{Cost-Accuracy Trade-off}\label{b.3-cost-accuracy-trade-off}
...
\subsection{Processing Time Analysis}\label{b.4-processing-time-analysis}
...
\subsection{Token Usage Statistics}\label{b.5-token-usage-statistics}
...
\section{Supplementary Figures}\label{appendix-c-supplementary-figures}

\subsection{Error Distribution Plots}\label{c.1-error-distribution-plots}
...
\subsection{Cost-Accuracy Tradeoff}\label{c.3-cost-accuracy-tradeoff}
...
\subsection{Latency-Accuracy Tradeoff}\label{c.4-latency-accuracy-tradeoff}
...
\section{Tool Augmentation Analysis}\label{appendix-d-tool-augmentation-analysis}
