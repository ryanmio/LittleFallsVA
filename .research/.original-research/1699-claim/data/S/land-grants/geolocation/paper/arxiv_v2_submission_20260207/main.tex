...
% Configure verbatim to use smaller font (helps with wrapping)
...
Pioneers} (C\&P) \cite{ref-Nugent1979_cavaliers3}. Without geographic
...
\item
  ...
  \cite{ref-Bashorun2025_gis}, deterministic pipelines such as the GeoTxt
...
al.~\cite{ref-Li2024_geoai} and detailed further in Section 2.4,
and---relative to classic geoparsers such as Stanford NER/GeoTxt
{[}@karimzadeh2019geotxt{]}, Mordecai‑3 {[}@halterman2023mordecai{]},
and the map‑aware CamCoder \cite{ref-Gritta2018_camcoder}---centers on
...
\item
  ...
  \emph{Cavaliers and Pioneers}, Vol. 3 \cite{ref-Nugent1979_cavaliers3},
...
\cite{ref-Julian2014_tennessee} required nearly ten years of archival
...
Virginia, seminal studies like Fausz \cite{ref-Fausz1971_settlement}
...
\cite{ref-Dobbs2009_backcountry} used georeferenced North Carolina grants
to demonstrate that eighteenth-century town sites often followed
pre-existing Indigenous trails, while Coughlan and Nelson
\cite{ref-Coughlan2018_settlement} leveraged a dataset of 1,160 South
...
DeedMapper software \cite{ref-DeedMapper_software} helps researchers
...
names. Neural architectures such as CamCoder \cite{ref-Gritta2018_camcoder}
...
al.~\cite{ref-Osullivan2024_metric} demonstrated that GPT-class models
...
with a cascading trio of geocoders---GeoNames \cite{ref-geonames_about},
Nominatim \cite{ref-nominatim_project}, and ArcGIS Online
...
Huang et al.~\cite{ref-Huang2024_geoagent} developed GeoAgent for free-form
...
initiative \cite{ref-GoogleResearch2025_geospatial} exemplifies the
...
al.~\cite{ref-Huang2024_geoagent}). The present work builds on this pattern
...
responsibility}, which Li et al.~\cite{ref-Li2024_geoai} identify as four
...
\emph{Cavaliers \& Pioneers}, Volume 3 \cite{ref-Nugent1979_cavaliers3}
...
A certified GIS analyst \cite{ref-Bashorun2025_gis} implemented an
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/error_violin_core_methods.pdf}}
...
\item
  ...
  Method rankings remain unchanged; only H-1 \cite{ref-Bashorun2025_gis}
...
\begin{subfigure}{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{mapping_workflow/map_outputs/grant_1_map.png}
...
\begin{subfigure}{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{mapping_workflow/map_outputs/grant_19_map.png}
...
\item
  ...
  \cite{ref-Bashorun2025_gis} relies on a single expert-authored geocoding
...
\item
  ...
  \emph{Cavaliers and Pioneers} \cite{ref-Nugent1979_cavaliers3}---and
...
are deeply grateful to Bimbola Bashorun \cite{ref-Bashorun2025_gis} for
...
Coughlan, M. R., \& Nelson, D. R. (2018). Influences of {Native
American} land use on the colonial {Euro-American} settlement of the
{South Carolina} {Piedmont}. \emph{PLOS ONE}, \emph{13}(3), e0195036.
\url{https://doi.org/10.1371/journal.pone.0195036}

\bibitem[\citeproctext]{ref-DeedMapper_software}
Direct Line Software. (2010). \emph{{DeedMapper} 4.2}. Commercial
software for historical deed mapping.
...
{Loudoun County}, {VA} {[}{GIS} dataset{]}}. Interactive {ArcGIS}
{WebMap}.
...
Mioduski, R. (2025). \emph{Colonial {Virginia} land-grant {OCR} corpus
(vol 3)}. Zenodo. Version 1.0.0.
...
in large language models. \emph{Proceedings of the 32nd {ACM}
{SIGSPATIAL} International Conference on Advances in Geographic
Information Systems ({SIGSPATIAL} '24)}, 501--504.
...
polygons {[}{CentralVAPatents\_PLY}{]}}. {ArcGIS Online} Feature
Service.
