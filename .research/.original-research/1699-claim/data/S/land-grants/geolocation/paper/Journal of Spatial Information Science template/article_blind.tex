...
% Add the running author and running title information (anonymized)
\runningauthor{\begin{minipage}{.9\textwidth}\centering [Author name removed for blind review]\end{minipage}}
\runningtitle{Benchmarking LLMs for Geolocating Colonial Virginia Land Grants}

% Document begins
\begin{document}

% Title, author, abstract, keywords and metadata (anonymized)
...
% Main body generated via Pandoc (anonymized version)
