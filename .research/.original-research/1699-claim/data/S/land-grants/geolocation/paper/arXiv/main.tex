...
\item
  ...
  OpenAI's GPT/o‑series snapshots from April--May 2025. Results may not
  transfer to other proprietary or open‑source families (e.g., Llama,
  Mistral) without replication; we treat cross‑model generalization as
  future work.
\item
