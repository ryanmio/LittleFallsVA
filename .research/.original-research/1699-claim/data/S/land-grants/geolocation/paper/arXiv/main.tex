...
during token selection: lower values approach deterministic outputs;
higher values increase variability. When supported (e.g., GPT‑4.1, 4o,
3.5), we set t = 0.2; OpenAI's o‑series uses fixed reasoning/decoding
and does not expose temperature. § 6.6 reports an ablation indicating
limited sensitivity to t within the tested range.
