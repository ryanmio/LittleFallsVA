...
errors for each evaluated method as the share of grants within a given
distance threshold. This curve allows comparison of accuracy across all
thresholds (e.g., 5--100 km), not just a single cutoff.

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{../analysis/figures/cdf_graphs/cdf_models_combined.pdf}}
\caption{Cumulative accuracy by distance threshold (km): for each
method, the curve shows the percentage of grants whose error is below
each threshold, enabling full‑range comparison of
accuracy.}\label{fig:cdf_models}
\end{figure}
...
\caption{\label{tbl:error_ci}Mean error with 95\% bootstrap confidence
intervals by method; complements the main-text accuracy
...
method, including dispersion and accuracy bands (≤10/25/50
km).}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Method
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1500}}@{}}
\caption{\label{tbl:cost_accuracy}Cost--accuracy summary by model family
(mean error, ≤10 km hit-rate, cost per 1,000 located, and marginal cost
per +1\% ≤10 km).}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}@{}}
\caption{\label{tbl:time_usage}Processing time by model: hours per
located, scaled hours per 1,000 located, and speedup versus the GIS
analyst baseline.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
runs (input, output, and tokens per 1,000 located
grants).}\tabularnewline
\toprule\noalign{}
...
by precision category (overall and by High/Medium/Low
...
\caption{Error boxplots by method: medians and interquartile ranges with
whiskers; complements the violin and CDF
views.}\label{fig:error_boxplot}
\end{figure}
...
\caption{Contact sheet of all mapped grants: ground truth (black stars)
and predictions, with dashed error lines.}\label{fig:contactsheet}
\end{figure}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}@{}}
\caption{\label{tbl:cost_marginal}Marginal cost to raise the ≤10 km
hit-rate by one percentage point for each model.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption{Latency--accuracy scatter: mean error (km) versus processing
time per grant (seconds; log-scale x-axis).}\label{fig:pareto_latency}
\end{figure}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 22\tabcolsep) * \real{0.0732}}
  >{\raggedright\arraybackslash}p{(\linewidth - 22\tabcolsep) * \real{0.0732}}@{}}
\caption{\label{tbl:tool_direct_comparison}Direct comparison of
identical models with and without tool access (controls for architecture
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1071}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1071}}@{}}
\caption{\label{tbl:tool_effect}Quantified effect of tool augmentation
on mean error and accuracy-band percentages (Δ indicates change with
tools).}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}
  >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}@{}}
\caption{\label{tbl:best_methods}Best-performing non-tool method versus
best tool-augmented method---head-to-head comparison across error
...
method and tool type (geocode versus centroid).}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}llll@{}}
\caption{\label{tbl:search_efficiency}Tool search efficiency metrics:
selected-call index and first-call success rate.}\tabularnewline
\toprule\noalign{}
