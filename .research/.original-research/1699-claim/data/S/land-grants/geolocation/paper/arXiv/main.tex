...
al.\textasciitilde{}{[}@Li2024\_geoai{]} and detailed further in §2.4.
...
on the GeoCorpora set (a benchmark of geotagged microtexts for toponym
resolution) {[}@karimzadeh2019geocorpora{]}, outperforming previous
neural methods and improving toponym resolution accuracy by 13\% over
the previous best neural system. On the less ambiguous WikToR corpus (a
Wikipedia-based corpus for region classification and toponym resolution)
{[}@gritta2018wiktor{]} the same architecture reached 0.98. Crucially,
these gains were realized on commodity hardware---the entire experiment
ran on a single NVIDIA V100 with 14 GB VRAM, showing that
...
cascading trio of geocoders---GeoNames gazetteer {[}@geonames{]},
Nominatim (OpenStreetMap geocoder) {[}@nominatim{]}, and ArcGIS World
Geocoding Service {[}@arcgis\_world\_geocoding{]}---to resolve toponyms
the model had already disambiguated linguistically. Their experiments
demonstrated that this hybrid pipeline raised Accuracy@161 km by 7--17
percentage points relative to either component used in isolation.
...
{[}@geoglue{]} and an in-house Chinese address dataset, demonstrating
improved F1 scores and edit-distance metrics.
...
responsibility}, which Li et al.\textasciitilde{}{[}@Li2024\_geoai{]}
identify as four essential pillars for solidifying GeoAI's scientific
rigor and ensuring its lasting, beneficial impact.
...
\bibitem[\citeproctext]{ref-arcgis_world_geocoding}
Esri. (2024). \emph{ArcGIS world geocoding service}. Global geocoding
service.
...
Gritta, M., Pilehvar, M. T., \& Collier, N. (2018a). Which melbourne?
...
\bibitem[\citeproctext]{ref-gritta2018wiktor}
Gritta, M., Pilehvar, M. T., \& Collier, N. (2018b). WikToR: A
wikipedia-based corpus for toponym resolution. \emph{Proceedings of the
...
\bibitem[\citeproctext]{ref-karimzadeh2019geocorpora}
Karimzadeh, M., Huang, W., Banerjee, S., \& Zhang, S. (2019).
GeoCorpora: Building a corpus to test and train microblog geoparsers.
\emph{Transactions in GIS}, \emph{23}(1), 80--94.
\url{https://doi.org/10.1111/tgis.12512}
...
\bibitem[\citeproctext]{ref-geoglue}
Mai, G., Yan, B., Janowicz, K., Gao, S., Zhang, R., Cai, L., \& Zhu, R.
(2020). \emph{GeoGLUE: A geospatial benchmark suite}. arXiv preprint.
...
OpenStreetMap Contributors. (2024). \emph{Nominatim: OpenStreetMap
geocoding}. Open-source geocoding software. \url{https://nominatim.org/}
...
\bibitem[\citeproctext]{ref-geonames}
The GeoNames Team. (2024). \emph{GeoNames}. Geographic database and web
services. \url{https://www.geonames.org}
