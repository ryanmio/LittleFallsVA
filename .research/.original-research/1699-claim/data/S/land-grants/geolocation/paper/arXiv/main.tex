...
higher values increase variability. Unless otherwise noted, we use t =
0.8 for single‑shot runs; § 6.6 reports an ablation showing accuracy is
largely insensitive to t over the tested range.
