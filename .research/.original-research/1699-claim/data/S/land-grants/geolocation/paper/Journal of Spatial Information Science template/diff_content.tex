...
\citep{Li2024_geoai} and detailed further in §2.4\DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{, and---relative to
...
next section (§ 2.3) explores \DIFdelbegin \DIFdel{tool-augmented }\DIFdelend \DIFaddbegin \DIFadd{tool‑augmented }\DIFaddend prompting frameworks that
...
\item
  \DIFaddbegin \textbf{\DIFadd{Model family scope.}} \DIFadd{Our LLM experiments are restricted to
