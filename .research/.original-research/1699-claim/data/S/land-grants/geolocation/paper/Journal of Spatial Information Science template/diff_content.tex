...
\DIFadd{Example grant abstract (C\&P, Vol. 3, 23 Oct.~1703, p.~571):
}
...
\DIFdelend 195.65 & 18.7 \\
E-2 & \DIFdelbegin \DIFdel{0.20003 }%DIFDELCMD < & %%%
\DIFdelend 200.03 & 20.4 \\
...
integrated via DBSCAN clustering \DIFaddbegin \DIFadd{(MinPts = 3)}\DIFaddend , reduces mean error to ≈19
...
them with DBSCAN (\DIFaddbegin \DIFadd{MinPts = 3; }\DIFaddend method E-1) pushes mean error down to ≈19
