...
\DIFaddbegin \DIFadd{Splits and validation sampling were produced by a deterministic
procedure with a fixed random seed (42), yielding the test partition
used for subsequent archival vetting.
}

\DIFaddend \subsection{Ground-Truth
