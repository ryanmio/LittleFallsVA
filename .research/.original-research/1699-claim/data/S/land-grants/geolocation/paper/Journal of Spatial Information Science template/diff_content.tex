...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1304}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1304}}@{}}
\caption{\label{tbl:accuracy}Coordinate-accuracy metrics \DIFaddbegin \DIFadd{on 43 grants
(mean ± 95\% CI, median, and ≤10 km share)}\DIFaddend .}\tabularnewline
\toprule\noalign{}
...
errors for each evaluated method. \DIFaddbegin \DIFadd{LLMs exhibit higher ≤10 km rates and
...
\caption{Cumulative error \DIFdelbeginFL \DIFdelFL{distribution by method}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{distributions; supports comparing ≤10 km rates
and tail behavior across methods.}\DIFaddendFL }\label{fig:cdf_models}
\end{figure}
