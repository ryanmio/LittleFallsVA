...
\DIFdelend \DIFaddbegin \DIFadd{geocode\_place}\DIFaddend , an interface to the Google Geocoding API limited
to Virginia and adjoining counties, and \DIFdelbegin %DIFDELCMD < \passthrough{\lstinline!compute\_centroid!}%%%
\DIFdelend \DIFaddbegin \DIFadd{compute\_centroid}\DIFaddend , which returns
