...
best-guess point estimate. }\DIFdelend \DIFaddbegin \DIFadd{returns a single coordinate from the input
text in one response; no external tools are invoked. }\DIFaddend By contrast, the
