...
errors for each evaluated method \DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{as the share of grants within a given
...
\caption{Cumulative \DIFdelbeginFL \DIFdelFL{error distribution }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{accuracy }\DIFaddendFL by \DIFaddbeginFL \DIFaddFL{distance threshold (km): for each
}\DIFaddendFL method\DIFaddbeginFL \DIFaddFL{, the curve shows the percentage of grants whose error is below
each threshold, enabling full‑range comparison of
accuracy.}\DIFaddendFL }\label{fig:cdf_models}
\end{figure}
...
\caption{\label{tbl:error_ci}Mean error with 95\% \DIFaddbegin \DIFadd{bootstrap }\DIFaddend confidence
intervals \DIFdelbegin \DIFdel{for each }\DIFdelend \DIFaddbegin \DIFadd{by }\DIFaddend method\DIFaddbegin \DIFadd{; complements the main-text accuracy
summary}\DIFaddend .}\tabularnewline
\toprule\noalign{}
...
method\DIFaddbegin \DIFadd{, including dispersion and accuracy bands (≤10/25/50
km)}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Method
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1500}}@{}}
\caption{\label{tbl:cost_accuracy}\DIFdelbegin \DIFdel{Cost-accuracy trade-off }\DIFdelend \DIFaddbegin \DIFadd{Cost--accuracy summary }\DIFaddend by model family
\DIFaddbegin \DIFadd{(mean error, ≤10 km hit-rate, cost per 1,000 located, and marginal cost
per +1\% ≤10 km)}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}@{}}
\caption{\label{tbl:time_usage}Processing time by model\DIFaddbegin \DIFadd{: hours per
located, scaled hours per 1,000 located, and speedup versus the GIS
analyst baseline}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\DIFdelbegin \DIFdel{test }\DIFdelend runs \DIFaddbegin \DIFadd{(input, output, and tokens per 1,000 located
grants)}\DIFaddend .}\tabularnewline
\toprule\noalign{}
...
by \DIFdelbegin \DIFdel{accuracy }\DIFdelend \DIFaddbegin \DIFadd{precision }\DIFaddend category \DIFaddbegin \DIFadd{(overall and by High/Medium/Low
placement)}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Accuracy Category
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption{Error \DIFdelbeginFL \DIFdelFL{Distribution Boxplot }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{boxplots }\DIFaddendFL by \DIFdelbeginFL \DIFdelFL{Method}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{method: medians and interquartile ranges with
whiskers; complements the violin and CDF
views.}\DIFaddendFL }\label{fig:error_boxplot}
\end{figure}
...
\caption{\DIFdelbeginFL \DIFdelFL{Grid view }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Contact sheet }\DIFaddendFL of all \DIFdelbeginFL \DIFdelFL{43 }\DIFdelendFL mapped grants\DIFdelbeginFL \DIFdelFL{showing }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{: }\DIFaddendFL ground truth \DIFaddbeginFL \DIFaddFL{(black stars)
}\DIFaddendFL and predictions\DIFaddbeginFL \DIFaddFL{, with dashed error lines}\DIFaddendFL .}\label{fig:contactsheet}
\end{figure}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}@{}}
\caption{\label{tbl:cost_marginal}Marginal cost to \DIFdelbegin \DIFdel{improve }\DIFdelend \DIFaddbegin \DIFadd{raise }\DIFaddend the ≤10 km
hit-rate by one percentage point \DIFaddbegin \DIFadd{for each model}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption{\DIFdelbeginFL \DIFdelFL{Latency-Accuracy Tradeoff}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Latency--accuracy scatter: mean error (km) versus processing
time per grant (seconds; log-scale x-axis).}\DIFaddendFL }\label{fig:pareto_latency}
\end{figure}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 22\tabcolsep) * \real{0.0732}}
  >{\raggedright\arraybackslash}p{(\linewidth - 22\tabcolsep) * \real{0.0732}}@{}}
\caption{\label{tbl:tool_direct_comparison}\DIFdelbegin \DIFdel{Side-by-side }\DIFdelend \DIFaddbegin \DIFadd{Direct }\DIFaddend comparison of
identical models with and without tool access \DIFaddbegin \DIFadd{(controls for architecture
effects)}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\DIFaddbegin \DIFadd{on mean error and accuracy-band percentages (Δ indicates change with
tools)}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}
  >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}@{}}
\caption{\label{tbl:best_methods}Best-performing \DIFdelbegin \DIFdel{methods per
category}\DIFdelend \DIFaddbegin \DIFadd{non-tool method versus
best tool-augmented method---head-to-head comparison across error
metrics}\DIFaddend .}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Method
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
method and tool type \DIFaddbegin \DIFadd{(geocode versus centroid)}\DIFaddend .}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}llll@{}}
\caption{\label{tbl:search_efficiency}Tool search efficiency metrics\DIFaddbegin \DIFadd{:
selected-call index and first-call success rate}\DIFaddend .}\tabularnewline
\toprule\noalign{}
