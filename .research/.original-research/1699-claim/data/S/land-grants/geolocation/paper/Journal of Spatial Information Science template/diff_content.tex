...
\caption{\DIFdelbeginFL \DIFdelFL{Distribution of per-grant }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Per-grant }\DIFaddendFL latency by method\DIFaddbeginFL \DIFaddFL{; automated inferences complete in 0.7–48 s versus ≈502 s for the GIS analyst baseline}\DIFaddendFL .}
