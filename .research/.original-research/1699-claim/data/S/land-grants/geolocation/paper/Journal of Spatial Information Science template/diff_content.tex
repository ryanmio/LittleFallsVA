...
\DIFaddbegin \DIFadd{Relative to classic geoparsers---gazetteer‑driven Stanford NER/GeoTxt
\mbox{%DIFAUXCMD
\citep{karimzadeh2019geotxt}}\hskip0pt%DIFAUXCMD
, neural Mordecai‑3
\mbox{%DIFAUXCMD
\citep{halterman2023mordecai}}\hskip0pt%DIFAUXCMD
, and map‑aware CamCoder
\mbox{%DIFAUXCMD
\citep{Gritta2018_camcoder}}\hskip0pt%DIFAUXCMD
---our inputs are long, archaic abstracts
...
\DIFaddend \subsection{Contributions}\label{contributions}
...
\DIFaddbegin \DIFadd{Most of these evaluations center on short, contemporary snippets (e.g.,
...
\DIFaddend \subsection{Tool-Augmented Prompting
...
\DIFaddbegin \DIFadd{Concretely, our experiments interleave geocoder queries and distance
...
normalization and GeoGLUE tasks
\mbox{%DIFAUXCMD
...
\DIFaddend \subsection{Emerging GeoAI Research
