...
\citep{Li2024_geoai} and detailed further in \DIFdelbegin \DIFdel{§}\DIFdelend \DIFaddbegin \DIFadd{Section }\DIFaddend 2.4\DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{, and---relative
...
testing whether a similar benefit materializes for colonial \DIFdelbegin \DIFdel{land-grant
}\DIFdelend \DIFaddbegin \DIFadd{land‑grant
}\DIFaddend geolocation---comparing a pure \DIFdelbegin \DIFdel{one-shot }\DIFdelend \DIFaddbegin \DIFadd{one‑shot }\DIFaddend prompt to a \DIFdelbegin \DIFdel{tool-augmented
chain-of-thought }\DIFdelend \DIFaddbegin \DIFadd{tool‑augmented
chain‑of‑thought }\DIFaddend that can issue \DIFdelbegin \DIFdel{mid-prompt geocoding and
