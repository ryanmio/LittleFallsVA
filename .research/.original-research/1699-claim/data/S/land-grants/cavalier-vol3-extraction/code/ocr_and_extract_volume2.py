...
def process_volume(
    ...
    csv_path = output_dir / "grant_blobs_volume2.csv"
...
def parse_args(argv: List[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="OCR & grant-entry extractor for Cavaliers & Pioneers Volume 2")
...
def main(argv: List[str] | None = None) -> None:
    ...
    try:
        ...
        # Final status message requested by project brief
        print(csv_path)
